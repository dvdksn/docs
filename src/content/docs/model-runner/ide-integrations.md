...
1. [Enable Docker Model Runner](get-started/#enable-docker-model-runner) in Docker Desktop or Docker Engine.
...
See [Open WebUI integration](openwebui-integration/) for detailed setup instructions.
...
- [Configuration options](configuration/) - Tune model behavior
- [Open WebUI integration](openwebui-integration/) - Set up a web interface
