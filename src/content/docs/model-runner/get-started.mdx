...
1. Docker Model Runner is available as a package. To install it, run:
   ...
   <TabItem label="RPM-base distributions">
...
<Tabs syncKey="release">
<TabItem label="From Docker Desktop">

1. Select **Models** and select the **Docker Hub** tab.
1. Find the model you want and select **Pull**.

![Screenshot showing the Docker Hub view.](/model-runner/images/dmr-catalog.png)

</TabItem>
<TabItem label="From the Docker CLI">
...
![Screenshot showing the Local view.](/model-runner/images/dmr-run.png)
...
use Docker Compose.
See [Models and Compose - Model configuration options](../compose/models-and-compose/#model-configuration-options).
...
![Screenshot showing the Models view.](/model-runner/images/dmr-logs.png)
...
- [Inference engines](./inference-engines/) - llama.cpp and vLLM details
...
- [Models and Compose](../compose/models-and-compose/) - Use models in Compose applications
