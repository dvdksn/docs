...
4. Optimize your storage by:
    ...
    - Regularly auditing and [removing entire repositories](../repos/delete/) with untagged, unused, or outdated images.
    - Using [Image Management](../repos/manage/hub-images/manage/) to remove stale and outdated images within a repository.
