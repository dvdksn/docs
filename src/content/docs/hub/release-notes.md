...
- Administrators can now prevent creating public repositories within
  ...
  repositories](./settings/#disable-creation-of-public-repos) setting.

## 2025-02-18

### New

- You can delete images and image indexes using [Image Management](./repos/manage/hub-images/manage/).
...
### New
 ...
 - You can tag Docker Hub repositories with [categories](./repos/manage/information/#repository-categories).
...
- Organizations with SSO enabled can assign members to roles, organizations, and teams with [SCIM role mapping](scim/#set-up-role-mapping).
...
- Docker Business subscribers can now [create a company](new-company/) in Docker Hub to manage organizations and settings.

## 2023-03-07

### New

-  You can now automatically sync user updates with your Docker organizations and teams with [Group Mapping](group-mapping/) for SSO and SCIM provisioning.
...
- The new [autobuild feature](../docker-hub/repos/manage/builds/manage-builds/#check-your-active-builds) lets you view your in-progress logs every 30 seconds instead of when the build is complete.
...
- You can now [export a CSV file of members](../admin/organization//members/#export-members) from organizations that you own.
...
- With [SCIM](scim/), you can manage users within your Okta identity provider (IdP). In addition, you can enable SCIM on organizations that are part of the Docker Business subscription.
...
- Organization owners can [invite new members](members/#invite-members) to an organization via Docker ID or email address.

## 2021-11-15

### New

- You can now purchase or upgrade to a Docker Business subscription using a credit card. To learn more, see [Upgrade your subscription](../subscription//change/).
...
For more information about this feature and for instructions on how to use it, see [Activity logs](../admin/organization/activity-logs/).

## 2020-11-10

### New feature

The **Repositories** view now shows which images have gone stale because they haven't been pulled or pushed recently. For more information, see [repository tags](repos/manage/access/#view-repository-tags).

## 2020-10-07

### New feature

Docker introduces Hub Vulnerability Scanning which enables you to automatically scan Docker images for vulnerabilities using Snyk. For more information, see [Hub Vulnerability Scanning](vulnerability-scanning/).
...
* The [billing page](../subscription/change/) for personal accounts has been updated. You can access the page at its new URL: [https://hub.docker.com/billing/plan](https://hub.docker.com/billing/plan).
