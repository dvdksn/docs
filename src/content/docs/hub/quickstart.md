...
- [Download and install Docker](../../get-started/get-docker/)
...
4. In the terminal, press <kbd>Ctrl+C</kbd> to stop the container.
...
Add [repository information](./repos/manage/information/) to help users find and use
your image.
