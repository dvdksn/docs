...
7. Select the default visibility.
   ...
   - **Private**: The repository doesn't appear in Docker Hub search results and
     ...
     permissions](/manuals/enterprise/security/roles-and-permissions/).
...
- [Repository information](./manage/information/)
- [Access](./manage/access/)
- [Images](./manage/hub-images/)
- [Automated builds](./manage/builds/)
- [Webhooks](./manage/webhooks/)
- [Image security insights](./manage/vulnerability-scanning/)
