...
![DVP flow in Docker Hub](/hub/repos/manage/trusted-content/images/dvp-hub-flow.svg)
...
badge](/hub/images/verified-publisher-badge.png)
...
3. Select the upload logo button, represented by a camera icon (<img src="/hub/images/upload_logo_sm.png" alt="camera icon" style="display:inline;height:1.2em;vertical-align:middle;" />) overlaying the
...
Select the **Clear** button (<img src="/hub/images/clear_logo_sm.png" alt="clear button" style="display:inline;height:1.2em;vertical-align:middle;" />) to remove a logo.

Removing the logo makes the repository default to using the organization logo,
if set, or the following default logo if not.

![Default logo which is a 3D grey cube](/hub/images/default_logo_sm.png)
