...
![Docker-Sponsored Open Source badge](/hub/images/sponsored-badge-iso.png)
...
3. Select the upload logo button, represented by a camera icon
   (<img src="/hub/images/upload_logo_sm.png" alt="camera icon" style="display:inline;height:1.2em;vertical-align:middle;" />)
...
![Fluent org with a Docker-Sponsored Open Source badge](/hub/images/sponsored-badge.png)
