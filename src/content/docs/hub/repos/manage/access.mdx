...
team](/manuals/admin/organization/manage-a-team/).
...
tokens](/manuals/enterprise/security/access-tokens/).
...
> [!NOTE]
> When you invite members, you assign them a role. See [Roles and permissions](/manuals/enterprise/security/roles-and-permissions/) for details about the access permissions for each role.
