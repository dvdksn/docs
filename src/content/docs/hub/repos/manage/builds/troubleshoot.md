...
![Timeline view showing the retry build button](/hub/repos/manage/builds/images/retry-build.png)
...
3. In Docker Hub, navigate to the build page for the repository that has linked private submodules. (If necessary, [follow the steps here](index/#configure-automated-builds) to configure the automated build.)
