...
If you are linking a source code provider to create autobuilds for a team, follow the instructions to [create a service account](index/#service-users-for-team-autobuilds) for the team before linking the account as described below.
...
4. Review the settings for the **Docker Hub Builder** OAuth application.
    ...
    ![Granting access to GitHub account](/hub/repos/manage/builds/images/authorize-builder.png)
    ...
    [Grant access to a GitHub organization](link-source/#grant-access-to-a-github-organization)
    to learn more.
...
![Bitbucket Authorization revocation page](/hub/repos/manage/builds/images/bitbucket-revoke.png)
