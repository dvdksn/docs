...
![List of builds showing the cancel icon](/hub/repos/manage/builds/images/build-cancelicon.png)
...
![Active builds](/hub/repos/manage/builds/images/index-active.png)
...
![Build report](/hub/repos/manage/builds/images/index-report.png)
...
a while, for example when you are doing major refactoring in your code. Disabling autobuilds doesn't disable [autotests](automated-testing/).
