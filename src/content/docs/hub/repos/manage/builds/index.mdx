...
<SummaryBar featureName="Automated builds" />

Docker Hub can automatically build images from source code in an external
repository and automatically push the built image to your Docker repositories.

![An automated build dashboard](/hub/repos/manage/builds/images/index-dashboard.png)
...
image. Automated tests don't push images to the registry on their own. [Learn about automated image testing](automated-testing/).
