...
> [`depends_on`](/reference/compose-file/services/#depends_on) are
> started. If you have services that poll for changes in other services, be sure
> to include the polling services in the [`depends_on`](/reference/compose-file/services/#depends_on)
...
You can also use [custom build hooks](advanced/#override-build-test-or-push-commands)
...
configured on the same page as [automated builds](index/), however
