...
* `hooks/pre_test`
* `hooks/post_test`
* `hooks/pre_push` (only used when executing a build rule or [Automated build](index/) )
* `hooks/post_push` (only used when executing a build rule or [Automated build](index/) )
