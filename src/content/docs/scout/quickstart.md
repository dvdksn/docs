...
you must enable the [containerd image store](/manuals/desktop/features/containerd/)
...
[Docker Scout's GitHub integration](./integrations/source-code-management/github/),
...
- [Image analysis](/manuals/scout/explore/analysis/)
