...
[Docker Scout CLI release notes](./cli/).
...
[Early Access](../../release-lifecycle/#early-access-ea) to
[General Availability](../../release-lifecycle/#genera-availability-ga).

For more information and setup instructions, see
[Integrate Azure Container Registry](../integrations/registry/acr/).
...
[Beta](../../release-lifecycle/#beta) launch of a new GitHub app for integrating
...
[Integrate Docker Scout with GitHub](../integrations/source-code-management/github/).
...
**Azure Container Registry** integration graduated from
[Beta](../../release-lifecycle/#beta) to
[Early Access](../../release-lifecycle/#early-access-ea).
...
[Beta](../../release-lifecycle/#beta) release of a new **Azure Container
...
For more information, see [Configurable policies](../policy/configure/).
...
![Policy overview in Dashboard](/scout/images/release-notes/policy-ea.webp)
...
documentation](../integrations/registry/ecr/).
...
documentation](../integrations/environment/sysdig/).
