...
- Create an exception in the [GUI](/manuals/scout/how-tos/create-exceptions-gui/) of
  Docker Scout Dashboard or Docker Desktop.
- Create a [VEX](/manuals/scout/how-tos/create-exceptions-vex/) document and attach
  it to the image.
...
- Exceptions created [using the GUI](/manuals/scout/how-tos/create-exceptions-gui/)
...
- Exceptions created [using VEX documents](/manuals/scout/how-tos/create-exceptions-vex/)
...
For exceptions created using the [GUI](/manuals/scout/how-tos/create-exceptions-gui/),
selecting the action menu lets you edit or remove the exception.

To view all exceptions for a specific image tag:

<Tabs>
<TabItem label="Docker Scout Dashboard">
...
<SummaryBar featureName="Docker Scout exceptions" />
