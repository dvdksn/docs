...
import Include_scout_early_access from "@includes/scout-early-access.mdx";
import { LinkButton } from "@astrojs/starlight/components";

<Include_scout_early_access />
...
>
> <LinkButton href="https://sysdig.com/free-trial-for-docker-customers/">Sign up</LinkButton>
...
images automatically, enable a [registry integration](../#container-registries).
...
> analysis, enable a [registry integration](../#container-registries)
