...
![Slack notification from Docker Scout](/scout/images/scout-slack-notification.png "Example Slack notification from Docker Scout")
...
see [Notification settings](/manuals/scout/explore/dashboard/#notification-settings)
