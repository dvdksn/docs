...
- [Amazon Elastic Container Registry](./registry/ecr/)
- [Azure Container Registry](./registry/acr/)
- [JFrog Artifactory](./registry/artifactory/)
...
- [GitLab](./ci/gitlab/)
- [Microsoft Azure DevOps Pipelines](./ci/azure/)
...
- [GitHub](source-code-management/github/) {{< badge color=blue text=Beta >}}
