...
<SummaryBar featureName="Docker Scout GitHub" />
...
attestations](/manuals/build/metadata/attestations/slsa-provenance/) to detect the
...
the [Up-to-Date Base Images policy](/manuals/scout/policy/#up-to-date-base-images-policy).
...
see [Remediation](../../policy/remediation/).
