...
![Policy overview](/scout/images/policy-overview.webp)
...
![Policy status in the image list](/scout/images/policy-image-list.webp)
...
![Detailed Policy Evaluation results](/scout/images/policy-detailed-results.webp)

This view also provides recommendations on how to improve improve policy status
for violated policies.

![Policy details in the tag view](/scout/images/policy-tag-view.webp)
