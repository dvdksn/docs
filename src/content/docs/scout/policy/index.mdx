...
[automatically analyzed](/scout/explore/analysis/). The analysis gives you insights
...
- The **SonarQube Quality Gates** policy, which requires
  [integration with SonarQube](/scout/integrations/code-quality/sonarqube/)
  before use.
...
[SBOM](/build/metadata/attestations/sbom/) and
...
learn how you can [configure the action](/build/ci/github-actions/attestations/)
...
Docker Scout uses [provenance](/build/metadata/attestations/slsa-provenance/)
...
attach [provenance attestations](/build/metadata/attestations/slsa-provenance/)
