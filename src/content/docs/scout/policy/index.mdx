...
[automatically analyzed](/manuals/scout/explore/analysis/). The analysis gives you insights
...
- The **SonarQube Quality Gates** policy, which requires
  [integration with SonarQube](/manuals/scout/integrations/code-quality/sonarqube/)
  before use.
...
information, refer to [Configure policies](./configure/).
...
For more information about configuring policies, see [Configure policies](./configure/).
...
See [Configure policies](./configure/).
...
For more information on policy configuration, see [Configure policies](./configure/).

### Supply Chain Attestations

The **Supply Chain Attestations** policy type checks whether your images have
[SBOM](/manuals/build/metadata/attestations/sbom/) and
[provenance](/manuals/build/metadata/attestations/slsa-provenance/) attestations.
...
learn how you can [configure the action](/manuals/build/ci/github-actions/attestations/)
...
[`USER`](/reference/dockerfile/#user) Dockerfile instruction to set
...
integration](../integrations/code-quality/sonarqube/) to assess the quality
...
Docker Scout uses [provenance](/manuals/build/metadata/attestations/slsa-provenance/)
...
![Git commit SHA links image with SonarQube analysis](/scout/images/scout-sq-commit-sha.webp)
...
attach [provenance attestations](/manuals/build/metadata/attestations/slsa-provenance/)
