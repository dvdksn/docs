...
<SummaryBar featureName="Remediation with Docker Scout" />
...
![Remediation for policy violations](/scout/images/remediation.png)
...
attestations](/manuals/build/metadata/attestations/slsa-provenance/) to your image. If
...
versions](/manuals/build/building/best-practices/#pin-base-image-versions).

### GitHub integration enabled

If you're hosting the source code for your image on GitHub, you can enable the
[GitHub integration](../integrations/source-code-management/github/). This
...
[`mode=max`](/manuals/build/metadata/attestations/slsa-provenance/#max) provenance.
