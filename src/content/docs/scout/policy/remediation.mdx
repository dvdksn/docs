...
attestations](/build/metadata/attestations/slsa-provenance/) to your image. If
...
versions](/build/building/best-practices/#pin-base-image-versions).
...
[`mode=max`](/build/metadata/attestations/slsa-provenance/#max) provenance.
