...
[type](/scout/policy/#policy-types). If the image is compliant
...
| Policy type                                                                                  | Points |
| -------------------------------------------------------------------------------------------- | ------ |
| [Severity-Based Vulnerability](/scout/policy/#severity-based-vulnerability) | 20     |
| [High-Profile Vulnerabilities](/scout/policy/#high-profile-vulnerabilities) | 20     |
| [Supply Chain Attestations](/scout/policy/#supply-chain-attestations)       | 15     |
| [Approved Base Images](/scout/policy/#approved-base-images)                 | 15     |
| [Up-to-Date Base Images](/scout/policy/#up-to-date-base-images)             | 10     |
| [SonarQube Quality Gates](/scout/policy/#sonarqube-quality-gates) \*        | 10     |
| [Default Non-Root User](/scout/policy/#default-non-root-user)               | 5      |
| [Compliant Licenses](/scout/policy/#compliant-licenses)                     | 5      |
