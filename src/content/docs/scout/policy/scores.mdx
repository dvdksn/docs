...
<SummaryBar featureName="Docker Scout health scores" />
...
![Repository health score](/scout/images/score-badges-repolist.png)
...
![Repository health score](/scout/images/score-badges-dd.png)
...
![Scout "A" health score](/scout/images/score-a-shiny.png)

## Scoring system

Health scores are determined by evaluating images against Docker Scout
[policies](./). These policies align with best practices for the
...
[type](/manuals/scout/policy/#policy-types). If the image is compliant
...
| Policy type                                                                                  | Points |
| -------------------------------------------------------------------------------------------- | ------ |
| [Severity-Based Vulnerability](/manuals/scout/policy/#severity-based-vulnerability) | 20     |
| [High-Profile Vulnerabilities](/manuals/scout/policy/#high-profile-vulnerabilities) | 20     |
| [Supply Chain Attestations](/manuals/scout/policy/#supply-chain-attestations)       | 15     |
| [Approved Base Images](/manuals/scout/policy/#approved-base-images)                 | 15     |
| [Up-to-Date Base Images](/manuals/scout/policy/#up-to-date-base-images)             | 10     |
| [SonarQube Quality Gates](/manuals/scout/policy/#sonarqube-quality-gates) \*        | 10     |
| [Default Non-Root User](/manuals/scout/policy/#default-non-root-user)               | 5      |
| [Compliant Licenses](/manuals/scout/policy/#compliant-licenses)                     | 5      |
...
compliant with the Docker Scout recommended [policies](./).
...
4. Analyze the [policy compliance](./) for your repositories,
