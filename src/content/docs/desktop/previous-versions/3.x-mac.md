...
- **Volume Management**: You can now sort volumes by the name, the date created, and the size of the volume. You can also search for specific volumes using the **Search** field. For more information, see [Explore volumes](../use-desktop/volumes/).
...
- [Docker Engine 20.10.8](/manuals/engine/release-notes/20.10/#20108)
...
**Volume Management**: Docker Desktop users can now create and delete volumes using the Docker Dashboard and also see which volumes are being used. For more information, see [Explore volumes](../use-desktop/volumes/).
...
- Docker Desktop no longer installs Notary. You can now use [Docker Content Trust](/manuals/engine/security/trust/) for image signing.

### Upgrades

- [Docker Engine 20.10.7](/manuals/engine/release-notes/20.10/#20107)
...
- [Docker Engine 20.10.6](/manuals/engine/release-notes/20.10/#20106)
...
- [Docker Engine 20.10.5](/manuals/engine/release-notes/20.10/#20105)
...
- [Docker Engine 20.10.3](/manuals/engine/release-notes/20.10/#20103)
...
- [Docker Engine 20.10.2](/manuals/engine/release-notes/20.10/#20102)
...
- [Docker Engine 20.10.0](/manuals/engine/release-notes/20.10/#20100)
