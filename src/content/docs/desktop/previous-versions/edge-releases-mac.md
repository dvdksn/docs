...
- Support paging of Docker Cloud [repositories](../../docker-hub/repos/) and [organizations](../../admin/organization/orgs/). Fixes [docker/for-mac#1538](https://github.com/docker/for-mac/issues/1538)
...
* Documentation moved to [/desktop/mac/](../)
