...
<Tabs>
<TabItem label="For Mac with Intel chip">
...
- **"Docker.app is damaged" dialog**: If you see a "Docker.app is damaged and can't be opened" dialog during installation or updates, this is typically caused by non-atomic copy operations when other applications are using the Docker CLI. See [Fix "Docker.app is damaged" on macOS](mac-damaged-dialog/) for resolution steps.
...
<TabItem label="For Mac with Apple silicon">
