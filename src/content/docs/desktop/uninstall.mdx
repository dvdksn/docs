...
> by the application. To preserve important data before uninstalling, refer to the [back up and restore data](/desktop/settings-and-maintenance/backup-and-restore/) section.
