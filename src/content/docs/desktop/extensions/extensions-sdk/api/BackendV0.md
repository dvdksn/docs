...
▸ **execInContainer**(`container`, `cmd`): `Promise`<[`ExecResultV0`](ExecResultV0/)\>
...
> [!WARNING]
>
> It will be removed in a future version. Use [get](HttpService/#get) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [post](HttpService/#post) instead.
...
> [!WARNING]
> 
> It will be removed in a future version. Use [put](HttpService/#put) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [patch](HttpService/#patch) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [delete](HttpService/#delete) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [head](HttpService/#head) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [request](HttpService/#request) instead.

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `config` | [`RequestConfigV0`](RequestConfigV0/) | The URL of the backend service. |
...
▸ **execInVMExtension**(`cmd`): `Promise`<[`ExecResultV0`](ExecResultV0/)\>
