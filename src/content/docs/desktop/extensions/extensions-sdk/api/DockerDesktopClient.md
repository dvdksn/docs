...
• `Readonly` **backend**: `undefined` \| [`BackendV0`](BackendV0/)
...
> [!WARNING]
>
> It will be removed in a future version. Use [extension](DockerDesktopClient/#extension) instead.
...
• `Readonly` **extension**: [`Extension`](Extension/)
...
• `Readonly` **desktopUI**: [`DesktopUI`](DesktopUI/)
...
> [!WARNING]
>
> It will be removed in a future version. Use [listContainers](Docker/#listcontainers) instead.

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `options` | `never` | (Optional). A JSON like `{ "all": true, "limit": 10, "size": true, "filters": JSON.stringify({ status: ["exited"] }), }` For more information about the different properties see [the Docker API endpoint documentation](https://docs.docker.com/engine/api/version/v1.52/#operation/ContainerList). |
...
> [!WARNING]
>
> It will be removed in a future version. Use [listImages](Docker/#listimages) instead.

#### Parameters

| Name | Type | Description |
| :------ | :------ | :------ |
| `options` | `never` | (Optional). A JSON like `{ "all": true, "filters": JSON.stringify({ dangling: ["true"] }), "digests": true }` For more information about the different properties see [the Docker API endpoint documentation](https://docs.docker.com/engine/api/version/v1.52/#tag/Image). |
...
> [!WARNING]
>
> It will be removed in a future version. Use [viewContainers](NavigationIntents/#viewcontainers) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [viewImages](NavigationIntents/#viewimages) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [viewImage](NavigationIntents/#viewimage) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [viewVolumes](NavigationIntents/#viewvolumes) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [viewVolume](NavigationIntents/#viewvolume) instead.
...
▸ **execHostCmd**(`cmd`): `Promise`<[`ExecResultV0`](ExecResultV0/)\>
...
> [!WARNING]
>
> It will be removed in a future version. Use [exec](ExtensionCli/#exec) instead.
...
`Promise`<[`ExecResultV0`](ExecResultV0/)\>
...
▸ **execDockerCmd**(`cmd`, `...args`): `Promise`<[`ExecResultV0`](ExecResultV0/)\>
...
> [!WARNING]
>
> It will be removed in a future version. Use [exec](DockerCommand/#exec) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [openExternal](Host/#openexternal) instead.
...
>**Warning`**
>
> It will be removed in a future version. Use [success](Toast/#success) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [warning](Toast/#warning) instead.
...
> [!WARNING]
>
> It will be removed in a future version. Use [error](Toast/#error) instead.
