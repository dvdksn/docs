...
See the [Docker API reference](/desktop/extensions/extensions-sdk/api/Docker/) for details about these methods.
...
▸ **exec**(`cmd`, `args`): `Promise`<[`ExecResult`](/desktop/extensions/extensions-sdk/api/ExecResult/)\>
...
See the [Exec API reference](/desktop/extensions/extensions-sdk/api/Exec/) for details about these methods.
