...
For more details about method parameters and the return types available, see [Toast API reference](/desktop/extensions/extensions-sdk/api/Toast/).
...
▸ **showOpenDialog**(`dialogProperties`): `Promise`<[`OpenDialogResult`](/desktop/extensions/extensions-sdk/api/OpenDialogResult/)\>:
...
For more details about method parameters and the return types available, see [Desktop host API reference](/desktop/extensions/extensions-sdk/api/Host/).
...
From your extension, you can also [navigate](dashboard-routes-navigation/) to other parts of the Docker Desktop Dashboard.
