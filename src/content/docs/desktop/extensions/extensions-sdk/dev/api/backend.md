...
The `ddClient.extension.vm` object can be used to communicate with the backend defined in the [vm section](../../architecture/metadata/#vm-section) of the extension metadata.
...
See [Service API Reference](/desktop/extensions/extensions-sdk/api/HttpService/) for other methods such as POST, UPDATE, and DELETE.
...
defined in the [vm section](../../architecture/metadata/#vm-section) of the
...
For more details, refer to the [Extension VM API Reference](/desktop/extensions/extensions-sdk/api/ExtensionVM/)
...
Invoke a binary on the host. The binary is typically shipped with your extension using the [host section](../../architecture/metadata/#host-section) in the extension metadata. Note that extensions run with user access rights, this API is not restricted to binaries listed in the [host section](../../architecture/metadata/#host-section) of the extension metadata (some extensions might install software during user interaction, and invoke newly installed binaries even if not listed in the extension metadata).
...
For more details, refer to the [Extension Host API Reference](/desktop/extensions/extensions-sdk/api/ExtensionHost/)
