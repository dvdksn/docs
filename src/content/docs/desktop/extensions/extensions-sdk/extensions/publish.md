...
Whenever you are [ready to publish](DISTRIBUTION/) your extension in the Marketplace, you can [self-publish your extension](https://github.com/docker/extensions-submissions/issues/new?assignees=&labels=&template=1_automatic_review.yaml&title=%5BSubmission%5D%3A+)
...
Before you submit your extension, it must pass the [validation](validate/) checks.
...
- Review the [design guidelines](../design/design-guidelines/)
- Ensure the [UI styling](../design/) is in line with Docker Desktop guidelines
