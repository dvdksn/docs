...
[Quickstart](../quickstart/). This creates a new directory `my-extension` that contains a fully functional extension.
...
For more information on the `ui` section of the `metadata.json`, see [Metadata](../architecture/metadata/#ui-section).
...
![Auto completion in an IDE](/desktop/extensions/extensions-sdk/build/images/types-autocomplete.png)
...
![Screenshot of the container list.](/desktop/extensions/extensions-sdk/build/images/react-extension.png)
...
> [!TIP]
>
> You can turn on [hot reloading](../dev/test-debug/#hot-reloading-whilst-developing-the-ui) to avoid the need to
> rebuild the extension every time you make a change.

## What's next?

- Add a [backend](backend-extension-tutorial/) to your extension.
...
- If you want to set up user authentication for the extension, see [Authentication](../guides/oauth2-flow/).
