...
> Tip
>
> If you want to start a codebase for your new extension, our [Quickstart guide](../quickstart/) and `docker extension init <my-extension>` provides a better base for your extension.
...
3. The source folder that contains all your HTML, CSS and JS files. There can also be other static assets such as logos
   and icons. For more information and guidelines on building the UI, see the [Design and UI styling section](../design/design-guidelines/).

## Create a Dockerfile

At a minimum, your Dockerfile needs:

- [Labels](../extensions/labels/) which provide extra information about the extension, icon and screenshots.
...
For more information on the `metadata.json`, see [Metadata](../architecture/metadata/).
...
![Minimal frontend extension](/desktop/extensions/extensions-sdk/build/images/ui-minimal-extension.png)

## What's next?

- Build a more [advanced frontend](frontend-extension-tutorial/) extension.
