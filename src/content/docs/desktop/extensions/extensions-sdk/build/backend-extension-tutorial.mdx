...
> Tip
>
> Check the [Quickstart guide](../quickstart/) and `docker extension init <my-extension>`. They provide a better base for your extension as it's more up-to-date and related to your install of Docker Desktop.

## Why add a backend?

Thanks to the Docker Extensions SDK, most of the time you should be able to do what you need from the Docker CLI
directly from [the frontend](frontend-extension-tutorial/#use-the-extension-apis-client).
...
For more information about extension backends, see [Architecture](../architecture/#the-backend).
...
For more information on the `vm` section of the `metadata.json`, see [Metadata](../architecture/metadata/).
...
Using the [advanced frontend extension example](frontend-extension-tutorial/), we can invoke our extension backend.
...
> See [Show extension containers](../dev/test-debug/#show-the-extension-containers) for more information.
...
- Learn how to [share and publish your extension](../extensions/).
