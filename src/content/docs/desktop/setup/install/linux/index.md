...
>
> <details>
<summary> Docker Desktop vs Docker Engine: What's the difference?</summary>
...
An experimental package is available for [Arch](archlinux/)-based distributions. Docker has not tested or verified the installation.
...
- Install Docker Desktop for Linux for your specific Linux distribution:
  ...
  - [Install on Debian](debian/)
  - [Install on Red Hat Enterprise Linux (RHEL)](rhel/)
  - [Install on Fedora](fedora/)
  - [Install on Arch](archlinux/)
