...
![Docker Desktop Dashboard on Containers view](/desktop/images/dashboard.webp) 

It provides a centralized interface to manage your [containers](container/), [images](images/), [volumes](volumes/), [builds](builds/), [Kubernetes resources](kubernetes/), and [logs](logs/).
...
Docker Desktop also includes a tray icon, referred to as the Docker menu <img src="/assets/images/whale-x.svg" alt="whale menu" style="display:inline;height:1.2em;vertical-align:middle;" /> for quick access.

Select the <img src="/assets/images/whale-x.svg" alt="whale menu" style="display:inline;height:1.2em;vertical-align:middle;" /> icon in your taskbar to open options such as:
