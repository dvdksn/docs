...
<SummaryBar featureName="Desktop logs" />

The **Logs** view provides a unified, real-time log stream from all running containers and Kubernetes nodes in Docker Desktop. Unlike the logs accessible from the [**Containers** view](container/), the **Logs** view lets you monitor and search log output across your entire environment from a single interface.
