...
The **Volumes** view in Docker Desktop lets you create, inspect, delete, clone, empty, export, and import [Docker volumes](/manuals/engine/storage/volumes/). You can also browse files and folders in volumes and see which containers are using them.
...
[start a container with a volume](/manuals/engine/storage/volumes/#start-a-container-with-a-volume)
...
To use the volume with a container, see [Use volumes](/manuals/engine/storage/volumes/#start-a-container-with-a-volume).
...
- [Use volumes](/manuals/engine/storage/volumes/)
