...
The **Volumes** view in Docker Desktop lets you create, inspect, delete, clone, empty, export, and import [Docker volumes](/engine/storage/volumes/). You can also browse files and folders in volumes and see which containers are using them.
...
[start a container with a volume](/engine/storage/volumes/#start-a-container-with-a-volume)
...
To use the volume with a container, see [Use volumes](/engine/storage/volumes/#start-a-container-with-a-volume).
...
5. Select whether to export the volume to **Local or Hub storage** or **External
   ...
   <Tabs>
   <TabItem label="Local or Hub storage">
   ...
   <TabItem label="External cloud storage">
...
- [Persisting container data](/get-started/build-your-first-app/)
- [Use volumes](/engine/storage/volumes/)
