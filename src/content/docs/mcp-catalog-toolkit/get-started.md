...
<SummaryBar featureName="Docker MCP Toolkit" />
...
> [!TIP]
> Prefer working from the terminal? See [Use MCP Toolkit from the CLI](cli/)
...
```console
$ claude "What MCP servers do I have?"
```
...
![Claude Desktop](/mcp-catalog-toolkit/images/claude-desktop.avif)
...
```console
$ codex "What MCP servers do I have?"
```
...
![Cursor](/mcp-catalog-toolkit/images/cursor.avif)
...
```console
$ gemini "What MCP servers do I have?"
```
...
![Goose desktop app](/mcp-catalog-toolkit/images/goose.avif)
...
![LM Studio](/mcp-catalog-toolkit/images/lm-studio.avif)
...
```console
$ opencode "What MCP servers do I have?"
```
...
![Docker MCP Toolkit in Sema4.ai Studio](/mcp-catalog-toolkit/images/sema4-mcp-list.avif)
...
![Editing an agent in Sema4.ai Studio](/mcp-catalog-toolkit/images/sema4-edit-agent.avif)
...
![MCP_DOCKER installed in Visual Studio Code](/mcp-catalog-toolkit/images/vscode-extensions.avif)
...
![Opening Zed agent settings from command palette](/mcp-catalog-toolkit/images/zed-cmd-palette.avif)

Ensure that `MCP_DOCKER` is listed and enabled in the MCP Servers section:

![MCP_DOCKER in Zed's agent settings](/mcp-catalog-toolkit/images/zed-agent-settings.avif)
