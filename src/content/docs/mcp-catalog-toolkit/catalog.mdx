...
<SummaryBar featureName="Docker MCP Catalog" />
...
to your [profiles](/ai-overview/mcp-catalog-and-toolkit/profiles/), you select
...
> AI agents. For more information, see [E2B Sandboxes](e2b-sandboxes/).
...
[Get started with MCP Toolkit](get-started/) or
...
- Define the server set available to AI agents using [Dynamic MCP](dynamic-mcp/)
...
[Custom catalogs](/ai-overview/mcp-catalog-and-toolkit/cli/#custom-catalogs)
...
- Docker Desktop's [MCP Toolkit feature](toolkit/).
