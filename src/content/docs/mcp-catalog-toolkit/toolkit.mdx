...
> [!TIP]
> The MCP Toolkit includes [Dynamic MCP](/ai-overview/mcp-catalog-and-toolkit/dynamic-mcp/),
...
- Image signing and attestation: All MCP server images under `mcp/` in the [MCP
  Catalog](catalog/) are built by Docker and digitally signed to verify their
...
<TabItem label="Enable globally">
   ...
   <TabItem label="Enable for a given project">
...
1. In Visual Studio Code, open a new Chat and select the **Agent** mode:
   ...
   ![Copilot mode switching](/mcp-catalog-toolkit/images/copilot-mode.png)

1. You can also check the available MCP tools:

   ![Displaying tools in VSCode](/mcp-catalog-toolkit/images/tools.png)
...
- [Use MCP Toolkit from the CLI](/ai-overview/mcp-catalog-and-toolkit/cli/)
