...
> [!TIP]
> The MCP Toolkit includes [Dynamic MCP](/manuals/ai/mcp-catalog-and-toolkit/dynamic-mcp/),
...
- [Use MCP Toolkit from the CLI](/manuals/ai/mcp-catalog-and-toolkit/cli/)
