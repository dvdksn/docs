...
Catalog](/manuals/ai/mcp-catalog-and-toolkit/catalog/) (the source of
...
[OAuth authentication](/manuals/ai/mcp-catalog-and-toolkit/toolkit/#oauth-authentication)
for details.
...
See [OAuth authentication](/manuals/ai/mcp-catalog-and-toolkit/toolkit/#oauth-authentication)
