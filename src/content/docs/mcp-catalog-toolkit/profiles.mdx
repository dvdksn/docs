...
<SummaryBar featureName="MCP Profiles" />
...
Catalog](/ai-overview/mcp-catalog-and-toolkit/catalog/) (the source of
...
[OAuth authentication](/ai-overview/mcp-catalog-and-toolkit/toolkit/#oauth-authentication)
for details.
...
See [OAuth authentication](/ai-overview/mcp-catalog-and-toolkit/toolkit/#oauth-authentication)
