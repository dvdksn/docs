...
> more information, see [E2B Sandboxes](sandboxes/).
...
Follow the [MCP Toolkit guide](toolkit/) to enable and configure servers
through the Docker Desktop interface, or see
[Use MCP Toolkit from the CLI](cli/) for terminal-based workflows.
