...
For more information about MCP concepts and how MCP servers work, see the [Docker MCP Catalog and Toolkit](index/) overview page.
...
> [!TIP]
> By default, the Gordon [client](/ai-overview/mcp-catalog-and-toolkit/toolkit/#install-an-mcp-client) is enabled,
...
1. Add the Docker Hub MCP Server configuration to your `claude_desktop_config.json`:
   ...
   <Tabs>
   <TabItem label="For public repositories only">
   ...
   <TabItem label="For authenticated access">
