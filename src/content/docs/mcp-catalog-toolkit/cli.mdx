...
after adding. See [OAuth authentication](/manuals/ai/mcp-catalog-and-toolkit/toolkit/#oauth-authentication).
...
them, see [Custom catalogs](/manuals/ai/mcp-catalog-and-toolkit/catalog/#custom-catalogs).
...
For [Dynamic MCP](/manuals/ai/mcp-catalog-and-toolkit/dynamic-mcp/), where
