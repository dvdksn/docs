...
after adding. See [OAuth authentication](/ai-overview/mcp-catalog-and-toolkit/toolkit/#oauth-authentication).
...
them, see [Custom catalogs](/ai-overview/mcp-catalog-and-toolkit/catalog/#custom-catalogs).
...
For [Dynamic MCP](/ai-overview/mcp-catalog-and-toolkit/dynamic-mcp/), where
