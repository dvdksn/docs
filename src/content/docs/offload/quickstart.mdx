...
[Docker Offload](./about/) lets you build and run containers in the cloud
...
> products](../admin/organization/manage-products/) to learn how to manage
...
settings](./configuration/), and then contact your administrator to verify
...
When Docker Offload is started, you'll see a cloud icon (<img src="/offload/images/cloud-mode.png" alt="Offload mode icon" style="display:inline;height:1.2em;vertical-align:middle;" />) in the Docker Desktop
...
Docker Desktop Dashboard footer next to the hourglass icon (<img src="/offload/images/hourglass-icon.png" alt="Offload session duration" style="display:inline;height:1.2em;vertical-align:middle;" />).
...
[idles](./about/#session-management-and-idle-state) if you do not respond to
