  ...
  docker:
    ...
    steps:
      ...
      - name: Build
        ...
        with:
          build-contexts: |
            alpine=docker-image://alpine:<Version name="example_alpine_version" />
          tags: myimage:latest
```
...
[`docker-container` driver](../../builders/drivers/docker-container/) for building with
named contexts. That's because this driver can't load an image from the Docker
store as it's isolated. To solve this problem you can use a [local registry](local-registry/)
