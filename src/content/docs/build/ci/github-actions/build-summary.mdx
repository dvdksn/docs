...
![A GitHub Actions build summary](/build/ci/images/gha_build_summary.png)
...
- `docker/build-push-action@<Version name="build_push_action_version" />`
- `docker/bake-action@<Version name="bake_action_version" />`
...
![Builds summary error message](/build/ci/images/build_summary_error.png)
...
the [Docker Desktop **Builds** view](/manuals/desktop/use-desktop/builds/).

To import the build record archive into Docker Desktop:

1. Download and install [Docker Desktop](/get-started/get-docker/).
