...
builds from a [Bake definition](../../../bake/) instead of a Dockerfile
...
publishes the result with tags generated from [metadata inputs](../manage-tags-labels/):
...
builds aren't supported because [SLSA provenance](../attestations/), digest
...
[GitHub Actions cache export](../../../cache/backends/gha/),
[Provenance defaults](../../../metadata/attestations/slsa-provenance/),
...
see [Multi-platform image](../multi-platform/). If your build does not need a
Bake definition, use [build.yml](build/) instead.
