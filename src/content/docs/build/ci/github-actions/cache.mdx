...
In most cases you want to use the [inline cache exporter](../../cache/backends/inline/).
...
configuration on the registry with the [registry cache exporter](../../cache/backends/registry/).
...
<SummaryBar featureName="Cache backend API" />

The [GitHub Actions cache exporter](../../cache/backends/gha/)
...
>   uses: docker/setup-compose-action@<Version name="setup_compose_action_version" />
>   with:
>    version: latest
> ```
>
...
using the [actions/cache](https://github.com/actions/cache) and [local cache exporter](../../cache/backends/local/)
with this action:
