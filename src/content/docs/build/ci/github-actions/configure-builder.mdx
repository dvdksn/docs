...
to your builder if you're using the [`docker-container` driver](/build/builders/drivers/docker-container/)
...
Here is an example using remote nodes with the [`remote` driver](/build/builders/drivers/remote/)
...
To be able to connect to an SSH endpoint using the [`docker-container` driver](/build/builders/drivers/docker-container/),
...
You can also [set up a remote BuildKit instance](/build/builders/drivers/remote/#example-remote-buildkit-in-docker-container)
...
For more information about remote builder, see [`remote` driver](/build/builders/drivers/remote/)
