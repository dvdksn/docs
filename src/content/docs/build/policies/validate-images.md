...
You should understand the policy basics from the [Introduction](./intro/):
...
- Learn [Git repository validation](./validate-git/) for source code inputs
- Browse [Example policies](./examples/) for complete policy patterns
- Read [Built-in functions](./built-ins/) for signature verification and
  attestation checking
- Check the [Input reference](./inputs/) for all available image fields
