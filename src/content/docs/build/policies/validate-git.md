...
functions](./built-ins/) for more details.
...
- Read [Built-in functions](./built-ins/) for Git signature verification
  functions
- Check the [Input reference](./inputs/) for all available Git fields
