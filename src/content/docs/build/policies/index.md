...
need to be a Rego expert - the [Introduction](./intro/) tutorial teaches you
everything needed.
...
Ready to start writing policies? The [Introduction](./intro/) tutorial walks
you through creating your first policy and teaches the Rego basics you need.

For practical usage guidance, see [Using build policies](./usage/).

For practical examples you can copy and adapt, see the [Example
policies](./examples/) library.
