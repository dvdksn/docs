...
[Introduction](./intro/), [Image validation](./validate-images/), and [Git
validation](./validate-git/). Those pages teach individual techniques. This
...
See the [Usage guide](./usage/) for complete bake integration details.
...
- Review [Built-in functions](./built-ins/) for signature verification and
  attestation checking
- Check the [Input reference](./inputs/) for all available fields you can
  validate
- Read the tutorials for detailed explanations:
  [Introduction](./intro/), [Image validation](./validate-images/), [Git
  validation](./validate-git/)
