...
[`BUILDX_NO_DEFAULT_ATTESTATIONS`](/manuals/build/building/variables/#buildx_no_default_attestations)
environment variable. See [Provenance attestation](./slsa-provenance/) for
...
[Image Attestation Storage (BuildKit)](attestation-storage/).
...
[`oci-artifact` option](/manuals/build/exporters/image-registry/#synopsis)
