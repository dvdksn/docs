...
- If the target directory is not empty, the contents of the target directory
  ...
  {/* details/summary not supported in MDX inside lists — using plain heading */}
...
- [.dockerignore files](/manuals/build/concepts/context/#dockerignore-files)
- [Cache invalidation](/manuals/build/cache/invalidation/)
- [Cache mounts](/reference/dockerfile/#run---mounttypecache)
- [Cache backend types](/manuals/build/cache/backends/)
