...
Depending on the type of [build driver](../builders/drivers/) you use,
...
GC is configured in the [`daemon.json` configuration file](/engine/cli/dockerd/#daemon-configuration-file),
...
[`buildkitd.toml`](../buildkit/toml-configuration/) configuration file. This
