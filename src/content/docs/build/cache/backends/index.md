...
`gha` cache backends, but only if you have enabled the [containerd image store](/desktop/features/containerd/).
Other cache backends require you to select a different [driver](/build/builders/drivers/).
