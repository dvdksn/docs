...
- [`ARG` Dockerfile reference](/build/dockerfile/#arg)
...
- [`ENV` Dockerfile reference](/build/dockerfile/#env)
...
[Multi-platform arguments](/build/dockerfile/#automatic-platform-args-in-the-global-scope)
...
[Proxy arguments](/build/dockerfile/#predefined-args).
...
[BuildKit built-in build args](/build/dockerfile/#buildkit-built-in-build-args).
