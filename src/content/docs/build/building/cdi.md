...
> [Docker Desktop](../../desktop/) is installed and [WSL 2 GPU Paravirtualization](../../desktop/features/gpu/#prerequisites)
...
In this section, we will show you how to set up a [container builder](../builders/drivers/docker-container/)
