...
equivalent options for [Bake](../bake/reference/#targetsecret).
...
use the [`--mount=type=secret`](/reference/dockerfile/#run---mounttypesecret)
...
SSH mount](/reference/dockerfile/#run---mounttypessh).
...
options for [Bake](../bake/reference/#targetssh).
