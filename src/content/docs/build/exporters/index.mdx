...
The `local` exporter is useful in [multi-stage builds](../building/multi-stage/)
...
<SummaryBar featureName="Build multiple exporters" />
...
- [Image and registry exporters](image-registry/)
- [OCI and Docker exporters](oci-docker/).
- [Local and tar exporters](local-tar/)
