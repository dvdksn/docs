...
- Incrementally transfer only the changed files in your
  [build context](../concepts/context/) between builds
- Detect and skip transferring unused files in your
  [build context](../concepts/context/)
- Use [Dockerfile frontend](frontend/) implementations with many
  additional features
...
{{< figure src="/build/images/buildkit-dag.svg" class="invertible" >}}
