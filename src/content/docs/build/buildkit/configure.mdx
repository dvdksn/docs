...
apply a custom [BuildKit configuration](toml-configuration/) by passing the
...
ARG BUILDKIT_VERSION=v<Version name="buildkit_version" />
...
for low-powered machines, using a [BuildKit configuration](toml-configuration/)
...
Now you can [create a `docker-container` builder](/manuals/build/builders/drivers/docker-container/)
