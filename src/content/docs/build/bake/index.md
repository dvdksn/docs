...
from a [Docker Compose file](./compose-file/). Here's an example Bake file in
HCL format:
...
target "backend" {
  ...
  args = {
    GO_VERSION = "<Version name="example_go_version" />"
  }
...
To learn how to get started with Bake, head over to the [Bake introduction](./introduction/).
