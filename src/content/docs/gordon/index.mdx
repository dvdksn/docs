---
title: Gordon
description: AI assistant for Docker workflows - execute tasks, debug issues, and manage containers with intelligent assistance
sidebar:
  order: 40
  badge:
    text: Beta
...
>    [Admin Console](/admin/enterprise/security/hardened-desktop/settings-management/configure-admin-console/).
...
4. Type a question: "What containers are running?"
   ...
   ![Gordon running in Docker Desktop](/gordon/images/gordon_gui.avif)
...
2. Type a question: "what containers are running?" and press <kbd>Enter</kbd>.
   ...
   ![Gordon running in the terminal](/gordon/images/gordon_tui.avif)
...
![Gordon permission request](/gordon/images/permissions.avif)

Permissions reset for each session. To configure default permissions or enable
auto-approve mode, see [Permissions](./how-to/permissions/).
