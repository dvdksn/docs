...
variable](/manuals/build/building/variables/#buildx_builder) to specify which
...
variable](/manuals/build/building/variables/#buildx_builder) to select the cloud builder.
...
It is possible to use Docker Build Cloud with a [private registry](/manuals/build-cloud/builder-settings/#private-resource-access)
