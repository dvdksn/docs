...
see the [Toolsets reference](./toolsets/).
...
> configuration options, see the [Toolsets reference](./toolsets/).
...
and `instruction` (usage guidance). See the [Toolsets reference](./toolsets/)
...
- Read the [Toolsets reference](./toolsets/) for detailed toolset
  documentation
- Review the [CLI reference](./cli/) for command-line options
- Browse [example
  configurations](https://github.com/docker/docker-agent/tree/main/examples)
- Learn about [sharing agents](../sharing-agents/)
