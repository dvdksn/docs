...
embedded in your editor instead, see [ACP integration](./acp/).
...
managing local files. See [Sharing agents](../sharing-agents/) for details.
...
- Check the [CLI reference](../reference/cli/) for all `docker agent serve mcp` options
- Browse [example
