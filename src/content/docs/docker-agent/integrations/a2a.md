...
For editor integration, see [ACP integration](./acp/). For using agents as
tools in MCP clients, see [MCP integration](./mcp/).
...
- Review the [CLI reference](../reference/cli/#a2a) for all `docker agent serve a2a`
  options
- Learn about [MCP mode](./mcp/) to expose agents as tools in MCP clients
- Learn about [ACP mode](./acp/) for editor integration
- Share your agents with [OCI registries](../sharing-agents/)
