...
- Follow the [tutorial](tutorial/) to build your first agent with local
  models
- Learn about [RAG](rag/) to give your agents access to codebases and
  documentation
- See the [configuration reference](reference/config/#docker-model-runner-dmr)
  for all DMR options
