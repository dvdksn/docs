...
reference](./reference/config/#task-delegation-versus-conversation-handoff).
...
- Review [configuration reference](./reference/config/) for all available
  options
- Check [toolsets reference](./reference/toolsets/) to understand what tools
  agents can use
- See [example
  configurations](https://github.com/docker/docker-agent/tree/main/examples) for
  complete working agents
- Read the [RAG guide](./rag/) for detailed retrieval optimization
