...
<SummaryBar featureName="Docker Agent" />
...
- Can use external tools via [MCP
  servers](/ai-overview/mcp-catalog-and-toolkit/mcp-gateway/)
...
- Follow the [tutorial](./tutorial/) to build your first coding agent
...
- Connect agents to external tools via the [Docker MCP
  Gateway](/ai-overview/mcp-catalog-and-toolkit/mcp-gateway/)
