...
The [Compose file](/compose/compose-file/) provides a way to document and configure
...
and destroy isolated testing environments for your test suite. By defining the full environment in a [Compose file](/compose/compose-file/), you can create and destroy these environments in just a few commands:
