...
- A [ConfigMap](https://kubernetes.io/docs/concepts/configuration/configmap/) with an entry for each and every [config](/compose/compose-file/configs/) resource in your Compose application.
