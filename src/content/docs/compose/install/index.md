...
- [Linux](/manuals/desktop/setup/install/linux/)
- [Mac](/manuals/desktop/setup/install/mac-install/)
- [Windows](/manuals/desktop/setup/install/windows-install/)

> [!TIP]
> 
> If you have already installed Docker Desktop, you can check which version of Compose you have by selecting **About Docker Desktop** from the Docker menu <img src="/desktop/images/whale-x.svg" alt="whale menu" style="display:inline;height:1.2em;vertical-align:middle;" />.
...
- [Using Docker's repository](linux/#install-using-the-repository)
- [Downloading and installing manually](linux/#install-the-plugin-manually)
...
You can [install the Docker Compose standalone](standalone/) on Linux or on Windows Server.
