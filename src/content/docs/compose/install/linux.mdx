...
1. Set up the repository. Find distribution-specific instructions in:
    ...
    [Ubuntu](/manuals/engine/install/ubuntu/#install-using-the-repository) |
    [CentOS](/manuals/engine/install/centos/#set-up-the-repository) |
    [Debian](/manuals/engine/install/debian/#install-using-the-repository) |
    [Raspberry Pi OS](/manuals/engine/install/raspberry-pi-os/#install-using-the-repository) |
    [Fedora](/manuals/engine/install/fedora/#set-up-the-repository) |
    [RHEL](/manuals/engine/install/rhel/#set-up-the-repository).
...
1.  To download and install the Docker Compose CLI plugin, run:
    ...
    $ curl -SL https://github.com/docker/compose/releases/download/<Version name="compose_version" />/docker-compose-linux-x86_64 -o $DOCKER_CONFIG/cli-plugins/docker-compose
    ```
    ...
    - A different version of Compose, substitute `<Version name="compose_version" />` with the version of Compose you want to use.
