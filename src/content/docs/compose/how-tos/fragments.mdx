...
import Include_compose_fragments from "@includes/compose/fragments.mdx";

<Include_compose_fragments />
...
Anchor resolution takes place before [variables interpolation](interpolation/), so variables can't be used to set anchors or aliases.
...
If you have an anchor that you want to use in more than one service, use it in conjunction with an [extension](extension/) to make your Compose file easier to maintain.
