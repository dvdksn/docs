...
The [`include` top-level element](/reference/compose-file/include/) helps to reflect the engineering team responsible for the code directly in the config file's organization. It also solves the relative path problem that [`extends`](extends/) and [merge](merge/) present. 
...
[`include` top-level element](/reference/compose-file/include/)
