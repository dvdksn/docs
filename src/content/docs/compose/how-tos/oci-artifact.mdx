...
sidebar:
  label: OCI artifact applications
  order: 110
---

import SummaryBar from "@components/SummaryBar.astro";

<SummaryBar featureName="Compose OCI artifact" />

Docker Compose supports working with [OCI artifacts](/hub/repos/manage/hub-images/oci-artifacts/), allowing you to package and distribute your Compose applications through container registries. This means you can store your Compose files alongside your container images, making it easier to version, share, and deploy your multi-container applications.
...
- If your OCI artifact application is using another remote resources, for example via [`include`](/compose/how-tos/multiple-compose-files/include/).
...
- [Learn about OCI artifacts in Docker Hub](/hub/repos/manage/hub-images/oci-artifacts/)
- [Compose publish command](/reference/cli/docker/compose/publish/)
- [Understand `include`](/compose/how-tos/multiple-compose-files/include/)
