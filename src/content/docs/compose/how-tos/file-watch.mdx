...
import Include_compose_configure_watch from "@includes/compose/configure-watch.mdx";
import Include_compose_watch from "@includes/compose/watch.mdx";
import SummaryBar from "@components/SummaryBar.astro";

<SummaryBar featureName="Compose file watch" />

<Include_compose_watch />
...
<Include_compose_configure_watch />
...
- [Compose Develop Specification](/reference/compose-file/develop/)
