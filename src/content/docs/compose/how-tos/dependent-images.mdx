...
<SummaryBar featureName="Compose dependent images" />
...
Using [Bake](/manuals/build/bake/) let you pass the complete build definition for all services
...
- [Learn about multi-stage Dockerfiles](/manuals/build/building/multi-stage/)
