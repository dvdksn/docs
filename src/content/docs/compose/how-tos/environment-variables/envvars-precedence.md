...
sidebar:
  label: Environment variables precedence
  order: 20
---
...
1. Set using [`docker compose run -e` in the CLI](set-environment-variables/#set-environment-variables-with-docker-compose-run---env).
...
- [Set environment variables in Compose](set-environment-variables/)
- [Use variable interpolation in Compose files](variable-interpolation/)
