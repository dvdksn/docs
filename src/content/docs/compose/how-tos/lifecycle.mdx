...
sidebar:
  label: Use lifecycle hooks
  order: 20
---

import SummaryBar from "@components/SummaryBar.astro";

<SummaryBar featureName="Compose lifecycle hooks" />

## Services lifecycle hooks

When Docker Compose runs a container, it uses two elements, 
[ENTRYPOINT and COMMAND](/engine/containers/run/#default-command-and-options), 
...
- [`post_start`](/compose/compose-file/services/#post_start)
- [`pre_stop`](/compose/compose-file/services/#pre_stop)
