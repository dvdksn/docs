...
3. The [top-level `name:` attribute](/compose/compose-file/version-and-name/) in your Compose file. Or the last `name:` if you [specify multiple Compose files](multiple-compose-files/merge/) in the command line with the `-f` flag.
