...
- [Secrets top-level element](/compose/compose-file/secrets/)
- [Secrets attribute for services top-level element](/compose/compose-file/services/#secrets)
