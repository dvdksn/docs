...
- Specifying a restart policy like [`restart: always`](/reference/compose-file/services/#restart)to avoid downtime
...
appropriately. For more information, see [pre-defined environment variables](environment-variables/envvars/).
...
- [Familiarize yourself with Compose's trust model](/manuals/compose/trust-model/)
