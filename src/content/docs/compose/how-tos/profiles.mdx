...
sidebar:
  label: Use service profiles
  order: 20
---

import Include_compose_profiles from "@includes/compose/profiles.mdx";

<Include_compose_profiles />

## Assigning profiles to services

Services are associated with profiles through the
[`profiles` attribute](/compose/compose-file/services/#profiles) which takes an
...
use the [`COMPOSE_PROFILES` environment variable](environment-variables/envvars/#compose_profiles):
...
[`profiles`](/compose/compose-file/services/#profiles)
