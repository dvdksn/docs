...
import Include_compose_extension from "@includes/compose/extension.mdx";

<Include_compose_extension />

Extensions can also be used with [anchors and aliases](fragments/).
