...
sidebar:
  label: Use AI models in Compose
  order: 10
---
...
- A platform that supports Compose models such as [Docker Model Runner (DMR)](/ai-overview/model-runner/#requirements).

## What are Compose models?

Compose `models` are a standardized way to define AI model dependencies in your application. By using the [`models` top-level element](/compose/how-tos/models/) in your Compose file, you can:
...
- `runtime_flags`: A list of raw command-line flags passed to the inference engine when the model is started.
   See [Configuration options](/ai-overview/model-runner/configuration/) for commonly used parameters and examples.
...
When [Docker Model Runner is enabled](/ai-overview/model-runner/):
...
- [`models` top-level element](/compose/how-tos/models/)
- [`models` attribute](/compose/compose-file/services/#models)
- [Docker Model Runner documentation](/ai-overview/model-runner/)
- [Configuration options](/ai-overview/model-runner/configuration/) - Context size and runtime parameters
- [Inference engines](/ai-overview/model-runner/inference-engines/) - llama.cpp and vLLM details
- [API reference](/ai-overview/model-runner/api-reference/) - OpenAI and Ollama-compatible APIs
