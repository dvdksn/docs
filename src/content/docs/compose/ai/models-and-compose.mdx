...
- A platform that supports Compose models such as [Docker Model Runner (DMR)](/manuals/ai/model-runner/#requirements).
...
- `runtime_flags`: A list of raw command-line flags passed to the inference engine when the model is started.
   See [Configuration options](/manuals/ai/model-runner/configuration/) for commonly used parameters and examples.
...
When [Docker Model Runner is enabled](/manuals/ai/model-runner/):
...
- [Docker Model Runner documentation](/manuals/ai/model-runner/)
- [Configuration options](/manuals/ai/model-runner/configuration/) - Context size and runtime parameters
- [Inference engines](/manuals/ai/model-runner/inference-engines/) - llama.cpp and vLLM details
- [API reference](/manuals/ai/model-runner/api-reference/) - OpenAI and Ollama-compatible APIs
