...
properties of the architecture, see [Sandbox isolation](security/isolation/).
...
enforces [network access policies](security/policy/) and handles
[credential injection](security/credentials/). See
[Network isolation](security/isolation/#network-isolation) for how this
works and [Default security posture](security/defaults/) for what is
