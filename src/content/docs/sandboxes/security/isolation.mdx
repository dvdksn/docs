...
host that enforces the [network policy](policy/). The sandbox routes
...
[injects credentials](credentials/) for AI services.
...
For how to store and manage credentials, see [Credentials](credentials/).
