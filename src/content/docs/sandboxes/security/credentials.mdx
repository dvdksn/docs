...
[Credential isolation](isolation/#credential-isolation).
...
> [Setting custom environment variables](../faq/#how-do-i-set-custom-environment-variables-inside-a-sandbox).
