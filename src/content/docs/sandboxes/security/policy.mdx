...
Sandboxes are [network-isolated](isolation/) from your host and from each
...
Use [`sbx policy allow`](/sandboxes/cli/sbx/policy/allow/) and
[`sbx policy deny`](/sandboxes/cli/sbx/policy/deny/) to add network access
...
| Value         | Description                                                                                         |
| ------------- | --------------------------------------------------------------------------------------------------- |
| `forward`     | Routed through the forward proxy. Supports [credential injection](credentials/).                  |
