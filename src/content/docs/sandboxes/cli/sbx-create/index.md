...
| Command | Description |
|---------|-------------|
| [`sbx create claude`](/sandboxes/cli/sbx-create-claude/) | Create a sandbox for claude |
| [`sbx create codex`](/sandboxes/cli/sbx-create-codex/) | Create a sandbox for codex |
| [`sbx create copilot`](/sandboxes/cli/sbx-create-copilot/) | Create a sandbox for copilot |
| [`sbx create docker-agent`](/sandboxes/cli/sbx-create-docker-agent/) | Create a sandbox for docker-agent |
| [`sbx create gemini`](/sandboxes/cli/sbx-create-gemini/) | Create a sandbox for gemini |
| [`sbx create kiro`](/sandboxes/cli/sbx-create-kiro/) | Create a sandbox for kiro |
| [`sbx create opencode`](/sandboxes/cli/sbx-create-opencode/) | Create a sandbox for opencode |
| [`sbx create shell`](/sandboxes/cli/sbx-create-shell/) | Create a sandbox for shell |
