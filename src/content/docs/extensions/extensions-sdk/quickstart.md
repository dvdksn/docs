...
For more information and guidelines on building the UI, see the [Design and UI styling section](design/design-guidelines/).
...
> extension. See [Preview whilst developing the UI](dev/test-debug/#hot-reloading-whilst-developing-the-ui) for more information.
...
[how to show extension containers](dev/test-debug/#show-the-extension-containers) for more information.

## Step four: Submit and publish your extension to the Marketplace

If you want to make your extension available to all Docker Desktop users, you can submit it for publication in the Marketplace. For more information, see [Publish](extensions/).
...
- Build a more [advanced frontend](build/frontend-extension-tutorial/) for your extension.
- Learn how to [test and debug](dev/test-debug/) your extension.
- Learn how to [setup CI for your extension](dev/continuous-integration/).
- Learn more about extensions [architecture](architecture/).
- Learn more about [designing the UI](design/design-guidelines/).
