...
3. Verify the published port by going to the **Containers** view of the Docker Desktop Dashboard.
   ...
   ![A screenshot of Docker Desktop Dashboard showing the published port](/get-started/docker-concepts/running-containers/images/published-ports.webp)
...
<LinkButton href="overriding-container-defaults">Overriding container defaults</LinkButton>
