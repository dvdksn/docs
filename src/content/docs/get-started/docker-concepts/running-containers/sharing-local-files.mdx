...
1. Delete the existing container by using the Docker Desktop Dashboard:
   ...
   ![A screenshot of Docker Desktop Dashboard showing how to delete the httpd container](/get-started/docker-concepts/running-containers/images/delete-httpd-container.webp)
...
1. You can view the mounted files inside a container by selecting the container's **Files** tab and then selecting a file inside the `/usr/local/apache2/htdocs/` directory. Then, select **Open file editor**.
   ...
   ![A screenshot of Docker Desktop Dashboard showing the mounted files inside the a container](/get-started/docker-concepts/running-containers/images/mounted-files.webp)
...
2. Delete the file on the host and verify the file is also deleted in the container. You will find that the files no longer exist under **Files** in the Docker Desktop Dashboard.
   ...
   ![A screenshot of Docker Desktop Dashboard showing the deleted files inside the a container](/get-started/docker-concepts/running-containers/images/deleted-files.webp)
...
<LinkButton href="Multi-container applications">Multi-container applications</LinkButton>
