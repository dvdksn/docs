...
![screenshot of the flowchart showing the concept of the image layers](/get-started/docker-concepts/building-images/images/container_image_layers.webp)
...
![screenshot of the flowchart showing the benefits of the image layering](/get-started/docker-concepts/building-images/images/container_image_layer_reuse.webp)
...
In this hands-on guide, you will create new image layers manually using the [`docker container commit`](https://docs.docker.com/reference/cli/docker/container/commit/) command. Note that you’ll rarely create images this way, as you’ll normally [use a Dockerfile](./writing-a-dockerfile/). But, it makes it easier to understand how it’s all working.
...
<LinkButton href="writing-a-dockerfile">Writing a Dockerfile</LinkButton>
