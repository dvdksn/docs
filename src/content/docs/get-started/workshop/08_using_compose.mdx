...
sidebar:
  label: "Part 7: Use Docker Compose"
  order: 80
---

import { LinkButton } from "@astrojs/starlight/components";

[Docker Compose](/manuals/compose/) is a tool that helps you define and
...
In [part 6](./07_multi_container/), you used the following command to start the application service.
...
<LinkButton href="09_image_best.md">Image-building best practices</LinkButton>
