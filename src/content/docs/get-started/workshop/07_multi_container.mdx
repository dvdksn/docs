...
sidebar:
  label: "Part 6: Multi-container apps"
  order: 70
---
...
![Todo App connected to MySQL container](/get-started/workshop/images/multi-container.webp)
...
2. Start a MySQL container and attach it to the network. You're also going to define a few environment variables that the
   ...
   <Tabs>
   <TabItem label="Mac / Linux / Git Bash">
...
<LinkButton href="08_using_compose.md">Use Docker Compose</LinkButton>
