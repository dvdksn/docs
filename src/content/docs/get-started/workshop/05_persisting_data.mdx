...
[Volumes](/manuals/engine/storage/volumes/) provide the ability to connect specific filesystem paths of 
...
1. Once the container starts up, open the app and add a few items to your todo list.
    ...
    ![Items added to todo list](/get-started/workshop/images/items-added.webp)
...
Related information:
 ...
 - [Volumes](/manuals/engine/storage/volumes/)

## Next steps

Next, you'll learn how you can develop your app more efficiently using bind mounts.

<LinkButton href="06_bind_mounts.md">Use bind mounts</LinkButton>
