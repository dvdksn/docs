...
In [part 4](./05_persisting_data/), you used a volume mount to persist the
...
filesystem you can share with containers. For details about accessing the setting, see [File sharing](/manuals/desktop/settings-and-maintenance/settings/#file-sharing).
...
<TabItem label="Command Prompt CLI">
...
2. Refresh the page in your web browser, and you should see the change reflected
   ...
   ![Screenshot of updated label for Add button](/get-started/workshop/images/updated-add-button.webp)
...
<LinkButton href="07_multi_container.md">Multi container apps</LinkButton>
