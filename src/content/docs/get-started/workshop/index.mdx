...
description: Get started with the Docker basics in this workshop, You'll learn about containers, images, and how to containerize your first application.
...
> applications, see [Getting started](/get-started/introduction/).
...
<LinkButton href="02_our_app.md">Containerize an application</LinkButton>
