...
sidebar:
  label: "Part 2: Update the application"
  order: 30
---
...
In [part 1](./02_our_app/), you containerized a todo application. In this part, you'll update the application and image. You'll also learn how to stop and remove a container.
...
<LinkButton href="04_sharing_app.md">Share the application</LinkButton>
