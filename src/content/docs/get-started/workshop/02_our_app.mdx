...
sidebar:
  label: "Part 1: Containerize an application"
  order: 20
---
...
2. After a few seconds, open your web browser to [http://localhost:3000](http://localhost:3000).
   ...
   ![Empty todo list](/get-started/workshop/images/todo-list-empty.webp)
...
![Docker Desktop with get-started container running](/get-started/workshop/images/dashboard-two-containers.webp)
...
<LinkButton href="03_updating_app.md">Update the application</LinkButton>
