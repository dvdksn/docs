...
<tbody>
<tr><th>Description</th><td>Parse, resolve and render compose file in canonical format</td></tr>
<tr><th>Usage</th><td><code>docker compose config [OPTIONS] [SERVICE...]</code></td></tr>
</tbody></table>
