...
<tbody>
<tr><th>Description</th><td>Docker Compose</td></tr>
<tr><th>Usage</th><td><code>docker compose</code></td></tr>
</tbody></table>
...
Use the `-f` flag to specify the location of a Compose [configuration file](/compose/compose-file/).
