...
<tr><th>Usage</th><td><code>docker volume ls [OPTIONS]</code></td></tr>
<tr><th>Aliases</th><td><code>docker volume list</code></td></tr>
</tbody></table>
...
|--------|---------|-------------|
| `--cluster` |  | **API 1.42+** Display only cluster volumes, and use cluster volume list formatting  |
