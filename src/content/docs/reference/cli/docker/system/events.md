...
<tbody>
<tr><th>Description</th><td>Get real time events from the server</td></tr>
<tr><th>Usage</th><td><code>docker system events [OPTIONS]</code></td></tr>
<tr><th>Aliases</th><td><code>docker events</code></td></tr>
</tbody></table>
