...
<tbody>
<tr><th>Description</th><td>Outputs the final config file, after doing merges and interpolations</td></tr>
<tr><th>Usage</th><td><code>docker stack config [OPTIONS]</code></td></tr>
</tbody></table>
