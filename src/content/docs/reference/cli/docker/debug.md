...
<tbody>
<tr><th>Description</th><td>Get a shell into any container or image. An alternative to debugging with `docker exec`.</td></tr>
<tr><th>Usage</th><td><code>debug [OPTIONS] {CONTAINER|IMAGE}</code></td></tr>
</tbody></table>
...
However, it can be difficult to understand all the corner cases from [Understand how CMD and ENTRYPOINT interact](/build/dockerfile/#understand-how-cmd-and-entrypoint-interact). 
...
Docs:
- https://docs.docker.com/build/dockerfile/#cmd
- https://docs.docker.com/build/dockerfile/#entrypoint
- https://docs.docker.com/build/dockerfile/#understand-how-cmd-and-entrypoint-interact
```
