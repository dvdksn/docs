...
<tbody>
<tr><th>Description</th><td>Compare two images and display differences (experimental)</td></tr>
<tr><th>Usage</th><td><code>docker scout compare --to IMAGE|DIRECTORY|ARCHIVE [IMAGE|DIRECTORY|ARCHIVE]</code></td></tr>
<tr><th>Aliases</th><td><code>docker scout diff</code></td></tr>
</tbody></table>
