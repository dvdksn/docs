...
<tbody>
<tr><th>Description</th><td>Evaluate policies against an image and display the policy evaluation results (experimental)
</td></tr>
<tr><th>Usage</th><td><code>docker scout policy [IMAGE | REPO]</code></td></tr>
</tbody></table>
