...
<tbody>
<tr><th>Description</th><td>Create a new image based on source images</td></tr>
<tr><th>Usage</th><td><code>docker buildx imagetools create [OPTIONS] [SOURCE...]</code></td></tr>
</tbody></table>
