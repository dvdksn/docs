...
<tbody>
<tr><th>Description</th><td>The base command for the Docker CLI.</td></tr>
</tbody></table>
...
| Command | Description |
|---------|-------------|
| [`docker attach`](/reference/cli/docker/attach/) | Attach local standard input, output, and error streams to a running container
 |
| [`docker bake`](/reference/cli/docker/bake/) | Build from a file |
| [`docker build`](/reference/cli/docker/build/) | Build an image from a Dockerfile |
...
| [`docker commit`](/reference/cli/docker/commit/) | Create a new image from a container's changes |
...
| [`docker cp`](/reference/cli/docker/cp/) | Copy files/folders between a container and the local filesystem |
| [`docker create`](/reference/cli/docker/create/) | Create a new container |
| [`docker diff`](/reference/cli/docker/diff/) | Inspect changes to files or directories on a container's filesystem |
| [`docker events`](/reference/cli/docker/events/) | Get real time events from the server |
| [`docker exec`](/reference/cli/docker/exec/) | Execute a command in a running container |
| [`docker export`](/reference/cli/docker/export/) | Export a container's filesystem as a tar archive |
| [`docker history`](/reference/cli/docker/history/) | Show the history of an image |
| [`docker image`](/reference/cli/docker/image/) | Manage images |
| [`docker images`](/reference/cli/docker/images/) | List images |
| [`docker import`](/reference/cli/docker/import/) | Import the contents from a tarball to create a filesystem image |
| [`docker info`](/reference/cli/docker/info/) | Display system-wide information |
| [`docker inspect`](/reference/cli/docker/inspect/) | Return low-level information on Docker objects |
| [`docker kill`](/reference/cli/docker/kill/) | Kill one or more running containers |
| [`docker load`](/reference/cli/docker/load/) | Load an image from a tar archive or STDIN |
...
| [`docker logs`](/reference/cli/docker/logs/) | Fetch the logs of a container |
...
| [`docker pause`](/reference/cli/docker/pause/) | Pause all processes within one or more containers |
| [`docker plugin`](/reference/cli/docker/plugin/) | Manage plugins |
| [`docker port`](/reference/cli/docker/port/) | List port mappings or a specific mapping for the container |
| [`docker ps`](/reference/cli/docker/ps/) | List containers |
| [`docker pull`](/reference/cli/docker/pull/) | Download an image from a registry |
| [`docker push`](/reference/cli/docker/push/) | Upload an image to a registry |
| [`docker rename`](/reference/cli/docker/rename/) | Rename a container |
| [`docker restart`](/reference/cli/docker/restart/) | Restart one or more containers |
| [`docker rm`](/reference/cli/docker/rm/) | Remove one or more containers |
| [`docker rmi`](/reference/cli/docker/rmi/) | Remove one or more images |
| [`docker run`](/reference/cli/docker/run/) | Create and run a new container from an image |
| [`docker save`](/reference/cli/docker/save/) | Save one or more images to a tar archive (streamed to STDOUT by default) |
...
| [`docker start`](/reference/cli/docker/start/) | Start one or more stopped containers |
| [`docker stats`](/reference/cli/docker/stats/) | Display a live stream of container(s) resource usage statistics |
| [`docker stop`](/reference/cli/docker/stop/) | Stop one or more running containers |
| [`docker swarm`](/reference/cli/docker/swarm/) | Manage Swarm |
| [`docker system`](/reference/cli/docker/system/) | Manage Docker |
| [`docker tag`](/reference/cli/docker/tag/) | Create a tag TARGET_IMAGE that refers to SOURCE_IMAGE |
| [`docker top`](/reference/cli/docker/top/) | Display the running processes of a container |
| [`docker unpause`](/reference/cli/docker/unpause/) | Unpause all processes within one or more containers |
| [`docker update`](/reference/cli/docker/update/) | Update configuration of one or more containers |
...
| [`docker wait`](/reference/cli/docker/wait/) | Block until one or more containers stop, then print their exit codes |
