...
<tbody>
<tr><th>Description</th><td>Download an image from a registry</td></tr>
<tr><th>Usage</th><td><code>docker image pull [OPTIONS] NAME[:TAG|@DIGEST]</code></td></tr>
<tr><th>Aliases</th><td><code>docker pull</code></td></tr>
</tbody></table>
...
daemon's proxy settings, refer to the [dockerd command-line reference](/engine/cli/dockerd/#proxy-configuration)
for details.
...
[insecure registries](/engine/cli/dockerd/#insecure-registries) section for more information.
