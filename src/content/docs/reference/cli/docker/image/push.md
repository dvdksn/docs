...
<tbody>
<tr><th>Description</th><td>Upload an image to a registry</td></tr>
<tr><th>Usage</th><td><code>docker image push [OPTIONS] NAME[:TAG]</code></td></tr>
<tr><th>Aliases</th><td><code>docker push</code></td></tr>
</tbody></table>
