...
<tbody>
<tr><th>Description</th><td>Run a model and interact with it using a submitted prompt or chat mode</td></tr>
<tr><th>Usage</th><td><code>docker model run MODEL [PROMPT]</code></td></tr>
</tbody></table>
