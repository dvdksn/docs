...
<tbody>
<tr><th>Description</th><td>List tasks running on one or more nodes, defaults to current node</td></tr>
<tr><th>Usage</th><td><code>docker node ps [OPTIONS] [NODE...]</code></td></tr>
</tbody></table>
