...
<tbody>
<tr><th>Description</th><td>Run an agent in a sandbox</td></tr>
<tr><th>Usage</th><td><code>docker sandbox run SANDBOX [-- AGENT_ARGS...] | AGENT [WORKSPACE] [EXTRA_WORKSPACE...] [-- AGENT_ARGS...]</code></td></tr>
</tbody></table>
...
|--------|---------|-------------|
| [`--name`](#name) |  | Name for the sandbox (default: <agent>-<workdir>) |
