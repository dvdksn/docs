...
<tbody>
<tr><th>Description</th><td>Return low-level information about keys and signatures</td></tr>
<tr><th>Usage</th><td><code>docker trust inspect IMAGE[:TAG] [IMAGE[:TAG]...]</code></td></tr>
</tbody></table>
