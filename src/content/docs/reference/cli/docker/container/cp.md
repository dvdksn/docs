...
<tbody>
<tr><th>Description</th><td>Copy files/folders between a container and the local filesystem</td></tr>
<tr><th>Usage</th><td><code>docker container cp [OPTIONS] CONTAINER:SRC_PATH DEST_PATH|-
	docker cp [OPTIONS] SRC_PATH|- CONTAINER:DEST_PATH</code></td></tr>
<tr><th>Aliases</th><td><code>docker cp</code></td></tr>
</tbody></table>
