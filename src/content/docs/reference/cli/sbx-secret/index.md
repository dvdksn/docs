...
| Command | Description |
|---------|-------------|
| [`sbx secret ls`](/reference/cli/sbx-secret-ls/) | List stored secrets |
| [`sbx secret rm`](/reference/cli/sbx-secret-rm/) | Remove a secret |
| [`sbx secret set`](/reference/cli/sbx-secret-set/) | Create or update a secret |
