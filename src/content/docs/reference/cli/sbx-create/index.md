...
| Command | Description |
|---------|-------------|
| [`sbx create claude`](/reference/cli/sbx-create-claude/) | Create a sandbox for claude |
| [`sbx create codex`](/reference/cli/sbx-create-codex/) | Create a sandbox for codex |
| [`sbx create copilot`](/reference/cli/sbx-create-copilot/) | Create a sandbox for copilot |
| [`sbx create docker-agent`](/reference/cli/sbx-create-docker-agent/) | Create a sandbox for docker-agent |
| [`sbx create gemini`](/reference/cli/sbx-create-gemini/) | Create a sandbox for gemini |
| [`sbx create kiro`](/reference/cli/sbx-create-kiro/) | Create a sandbox for kiro |
| [`sbx create opencode`](/reference/cli/sbx-create-opencode/) | Create a sandbox for opencode |
| [`sbx create shell`](/reference/cli/sbx-create-shell/) | Create a sandbox for shell |
