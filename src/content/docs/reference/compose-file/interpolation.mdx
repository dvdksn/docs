...
import Include_compose_interpolation from "@includes/compose/interpolation.mdx";

<Include_compose_interpolation />
...
user-defined strings, such as [labels](services/#labels) or [environment](services/#environment), an alternate equal sign syntax
