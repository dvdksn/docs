...
The [services](services/) top-level element supports a `profiles` attribute to define a list of named profiles. 
...
Learn how to use `profiles` in [Docker Compose](/manuals/compose/how-tos/profiles/).
