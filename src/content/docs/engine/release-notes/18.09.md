...
> ```
> 
> See the [installation instructions](../install/) for the corresponding
...
supported at this time, but support will be removed in a future release.
  ...
  The [Overlay2 storage driver](/manuals/engine/storage/drivers/overlayfs-driver/) is now the default for Docker Engine implementations.
