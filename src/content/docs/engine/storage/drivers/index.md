...
[Best practices for writing Dockerfiles](/build/building/best-practices/)
and [use multi-stage builds](/build/building/multi-stage/)
...
- Disk space used for log files stored by the [logging-driver](/engine/logging/).
...
8. Check out the history of each image.
   ...
   images for caching. Refer to [BuildKit](/build/buildkit/)
...
9. Check out the layers for each image
   ...
   > [format command and log output section](/engine/cli/formatting/).
