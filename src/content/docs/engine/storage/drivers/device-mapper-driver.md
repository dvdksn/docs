...
> **Deprecated**
>
> The Device Mapper driver [has been deprecated](/engine/deprecated/#device-mapper-storage-driver),
...
> Engine v25.0. Read the [Docker storage drivers](select-storage-driver/)
...
2.  Edit `/etc/docker/daemon.json`. If it does not yet exist, create it. Assuming
    ...
    [daemon reference documentation](/engine/cli/dockerd/#options-per-storage-driver)
...
See the
[storage driver options in the Engine daemon reference](/engine/cli/dockerd/#daemon-storage-driver).
...
![Ubuntu and busybox image layers](/engine/storage/drivers/images/two_dm_container.webp)
...
![Reading a block with devicemapper](/engine/storage/drivers/images/dm_container.webp)
