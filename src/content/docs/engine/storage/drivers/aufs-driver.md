...
> before upgrading to Docker Engine v24.0. Read the [Docker storage drivers](select-storage-driver/)
...
[overlay2](overlayfs-driver/), which has
...
![Layers of an Ubuntu container](/engine/storage/drivers/images/aufs_layers.webp) 
