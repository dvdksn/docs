...
**Daemon storage backends** ([containerd image store](containerd/) and
...
[containerd image store](containerd/) or [Storage drivers](drivers/).
...
- [containerd image store](containerd/)
