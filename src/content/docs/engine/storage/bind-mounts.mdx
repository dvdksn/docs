...
[Compose reference on the volumes top-level element](/compose/compose-file/volumes/).
and
[Compose reference on the volume attribute](/compose/compose-file/services/#volumes).
