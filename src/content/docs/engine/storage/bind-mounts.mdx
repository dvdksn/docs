...
If you're on Windows, see also [Path conversions on Windows](/manuals/desktop/troubleshoot-and-support/troubleshoot/topics/).
...
behavior differs from that of [volumes](volumes/).
...
[Compose reference on the volumes top-level element](/reference/compose-file/volumes/).
and
[Compose reference on the volume attribute](/reference/compose-file/services/#volumes).

## Next steps

- Learn about [volumes](./volumes/).
- Learn about [tmpfs mounts](./tmpfs/).
