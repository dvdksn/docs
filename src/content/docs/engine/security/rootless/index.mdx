...
This is similar to [`userns-remap` mode](../userns-remap/), except that
...
<Tabs>
<TabItem label="With packages (RPM/DEB)">
...
<TabItem label="Without packages">
...
See [Troubleshooting](./troubleshoot/) if you faced an error.