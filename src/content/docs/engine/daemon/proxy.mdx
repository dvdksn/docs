...
Docker CLI to use a proxy server](/manuals/engine/cli/proxy/).
...
> [Docker Desktop settings](/manuals/desktop/settings-and-maintenance/settings/#proxies).
...
> in [rootless mode](/manuals/engine/security/rootless/). When running in
