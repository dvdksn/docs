...
Docker CLI to use a proxy server](/engine/cli/proxy/).
...
> [Docker Desktop settings](/desktop/settings-and-maintenance/settings/#proxies).
...
> in [rootless mode](/engine/security/rootless/). When running in
