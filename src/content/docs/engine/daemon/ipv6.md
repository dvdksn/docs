...
The built-in default address pool configuration is shown in [Subnet allocation](../network/#subnet-allocation).
...
See [Subnet allocation](../network/#subnet-allocation) for more information about
`default-address-pools`.
