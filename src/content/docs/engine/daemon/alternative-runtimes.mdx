...
[Configure containerd shims](/engine/cli/dockerd/#configure-containerd-shims).
...
[Configure runc drop-in replacements](/engine/cli/dockerd/#configure-runc-drop-in-replacements).
...
- To learn more about the configuration options for container runtimes,
  see [Configure container runtimes](/engine/cli/dockerd/#configure-container-runtimes).
- You can configure which runtime that the daemon should use as its default.
  Refer to [Configure the default container runtime](/engine/cli/dockerd/#configure-the-default-container-runtime).
