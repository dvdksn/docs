...
sidebar:
  label: Raspberry Pi OS (32-bit / armhf)
  order: 50
---

import Include_engine_license from "@includes/engine-license.mdx";
import Include_install_script from "@includes/install-script.mdx";
import Include_root_errors from "@includes/root-errors.mdx";
...
>   [Debian installation instructions](debian/).
...
> instructions for [Debian](debian/).
...
- If you use ufw or firewalld to manage firewall settings, be aware that
  ...
  [Docker and ufw](/manuals/engine/network/packet-filtering-firewalls/#docker-and-ufw).
- Docker is only compatible with `iptables-nft` and `iptables-legacy`.
  ...
  see [Packet filtering and firewalls](/manuals/engine/network/packet-filtering-firewalls/).
...
>
> Migration options:
> - 64-bit ARM: use Debian `arm64` packages; see the [Debian installation instructions](debian/).
...
- Docker Engine comes bundled with
  [Docker Desktop for Linux](/manuals/desktop/setup/install/linux/). This is
...
2. Install the Docker packages.
   ...
   <TabItem label="Specific version">
   ...
   5:<Version name="docker_ce_version" />-1~raspbian.12~bookworm
   5:<Version name="docker_ce_version_prev" />-1~raspbian.12~bookworm
   ...
   ```
   ...
   ```console
   $ VERSION_STRING=5:<Version name="docker_ce_version" />-1~raspbian.12~bookworm
...
- Continue to [Post-installation steps for Linux](linux-postinstall/).
