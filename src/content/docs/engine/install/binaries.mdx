...
> packages.
>
> On Windows and Mac, we recommend that you install [Docker Desktop](/manuals/desktop/)
...
> [Docker Desktop](/manuals/desktop/) instead.
...
> we recommend that you install [Docker Desktop](/manuals/desktop/) instead.
