...
keywords: requirements, dnf, installation, fedora, install fedora, install docker engine, rpm, install, uninstall, upgrade, update
sidebar:
  label: Fedora
  order: 40
---
...
1. Install the Docker packages.
   ...
   docker-ce.x86_64    3:<Version name="docker_ce_version" />-1.fc41    docker-ce-stable
   docker-ce.x86_64    3:<Version name="docker_ce_version_prev" />-1.fc41    docker-ce-stable
   &lt;...>
   ```
   ...
   separated by a hyphen (`-`). For example, `docker-ce-3:<Version name="docker_ce_version" />-1.fc41`.
