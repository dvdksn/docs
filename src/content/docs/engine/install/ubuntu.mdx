...
2. Install the Docker packages.
   ...
   docker-ce/noble 5:<Version name="docker_ce_version" />-1~ubuntu.24.04~noble <arch>
   docker-ce/noble 5:<Version name="docker_ce_version_prev" />-1~ubuntu.24.04~noble <arch>
   ...
   ```
   ...
   ```console
   $ VERSION_STRING=5:<Version name="docker_ce_version" />-1~ubuntu.24.04~noble
