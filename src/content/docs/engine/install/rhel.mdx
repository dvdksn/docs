...
keywords: requirements, dnf, installation, rhel, rpm, install, install docker engine, uninstall, upgrade, update
sidebar:
  label: RHEL
  order: 30
---
...
1. Install the Docker packages.
   ...
   docker-ce.x86_64    3:<Version name="docker_ce_version" />-1.el9    docker-ce-stable
   docker-ce.x86_64    3:<Version name="docker_ce_version_prev" />-1.el9    docker-ce-stable
   &lt;...>
   ```
   ...
   separated by a hyphen (`-`). For example, `docker-ce-3:<Version name="docker_ce_version" />-1.el9`.
