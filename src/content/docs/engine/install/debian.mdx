...
2. Install the Docker packages.
   ...
   docker-ce/bookworm 5:<Version name="docker_ce_version" />-1~debian.12~bookworm <arch>
   docker-ce/bookworm 5:<Version name="docker_ce_version_prev" />-1~debian.12~bookworm <arch>
   ...
   ```
   ...
   ```console
   $ VERSION_STRING=5:<Version name="docker_ce_version" />-1~debian.12~bookworm
