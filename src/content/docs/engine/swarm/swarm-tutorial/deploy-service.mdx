...
After you [create a swarm](create-swarm/), you can deploy a service to the
swarm. For this tutorial, you also [added worker nodes](add-nodes/), but that
...
<LinkButton href="inspect-service.md">Inspect the service</LinkButton>
