...
may want to familiarize yourself with the [key concepts](../key-concepts/)
before you begin.
...
[Deploy to Swarm](/guides/swarm-deploy/#prerequisites) for one possible set-up for the hosts.
...
* [Customize the default ingress network](../networking/) to use encryption
...
<LinkButton href="create-swarm.md">Create a swarm</LinkButton>
