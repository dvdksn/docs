...
![ HTTP listener service with three replicas](/engine/swarm/images/services-diagram.webp)
...
![Services flow](/engine/swarm/images/service-lifecycle.webp)
...
![Global vs replicated services](/engine/swarm/images/replicated-vs-global.webp)

## Learn more

- Read about how Swarm mode [nodes](nodes/) work.
- Learn how [PKI](pki/) works in Swarm mode.
