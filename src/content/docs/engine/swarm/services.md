...
For an overview of Swarm mode, see [Swarm mode key concepts](key-concepts/).
For an overview of how services work, see
[How services work](how-swarm-mode-works/services/).
...
[Pending services](how-swarm-mode-works/services/#pending-services) for more
information.
...
- If you specify a tag, the manager (or the Docker client, if you use
  [content trust](../security/trust/)) resolves that tag to a digest.
...
> [!NOTE]>
>
> If [content trust](../security/trust/) is
...
> [!NOTE]
>
> If you use [content trust](../security/trust/), the Docker
...
[Manage swarm service networks](networking/).
...
[Attach services to an overlay network](networking/) and
...
[Manage sensitive strings (secrets) for Docker services](secrets/)
...
see
[Understand the risks of running out of memory](/manuals/engine/containers/resource_constraints/#understand-the-risks-of-running-out-of-memory).
...
[label](manage-nodes/#add-or-remove-label-metadata) `region` set
...
![How placement preferences work](/engine/swarm/images/placement_prefs.png)
...
drivers, see [Use volumes](/manuals/engine/storage/volumes/).
