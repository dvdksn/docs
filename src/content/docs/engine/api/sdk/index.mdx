...
> ```
>
> For more details, see [the Linux FAQs](/desktop/troubleshoot-and-support/faqs/linuxfaqs/#how-do-i-use-docker-sdks-with-docker-desktop-for-linux).
...
For more examples, take a look at the [SDK examples](examples/).
