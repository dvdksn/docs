...
![Authorization Allow flow](/images/engine/extend/authz_allow.png)

![Authorization Deny flow](/images/engine/extend/authz_deny.png)
...
to the [`dockerd` documentation](https://docs.docker.com/engine/cli/dockerd/#configuration-reload-behavior) for more information.
