...
isolation, [port publishing](./port-publishing/) and filtering.
...
see [Docker with iptables](./firewall-iptables/). It also has
support for nftables, see [Docker with nftables](./firewall-nftables/).
...
> [Migrating from iptables to nftables](./firewall-nftables/#migrating-from-iptables-to-nftables).
