...
| Driver                          | Description                                                         |
| :------------------------------ | :------------------------------------------------------------------ |
| [bridge](./drivers/bridge/)   | The default network driver.                                         |
| [host](./drivers/host/)       | Remove network isolation between the container and the Docker host. |
| [none](./drivers/none/)       | Completely isolate a container from the host and other containers.  |
| [overlay](./drivers/overlay/) | Swarm Overlay networks connect multiple Docker daemons together.    |
| [ipvlan](./drivers/ipvlan/)   | Connect containers to external VLANs.                               |
| [macvlan](./drivers/macvlan/) | Containers appear as devices on the host's network.                 |
...
`default-address-pools`. See [Dynamic IPv6 subnet allocation](../daemon/ipv6/#dynamic-ipv6-subnet-allocation)
...
[custom network](drivers/bridge/#use-user-defined-bridge-networks)
