...
>
> See [Differences between user-defined bridges and the default bridge](drivers/bridge/#differences-between-user-defined-bridges-and-the-default-bridge)
...
Before the [Docker networks feature](index/), you could use the
...
[user defined networks](drivers/bridge/#differences-between-user-defined-bridges-and-the-default-bridge).
...
> Refer to [differences between user-defined bridges and the default bridge](drivers/bridge/#differences-between-user-defined-bridges-and-the-default-bridge)
