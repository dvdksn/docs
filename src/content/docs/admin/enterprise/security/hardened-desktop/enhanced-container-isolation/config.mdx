...
Create an [`admin-settings.json` file](/admin/enterprise/security/hardened-desktop/settings-management/configure-json-file/) and add:
...
- Review [Enhanced Container Isolation FAQs](/admin/enterprise/security/hardened-desktop/enhanced-container-isolation/faq/).
