...
- [Enforced sign-in](/admin/enterprise/security/enforce-sign-in/) (for administrators managing organization-wide settings only)
...
1. [Create or edit a setting policy](/admin/enterprise/security/hardened-desktop/settings-management/configure-admin-console/).
1. Set **Enhanced Container Isolation** to **Always enabled**.

</TabItem>
<TabItem label="JSON file">

1. Create an [`admin-settings.json` file](/admin/enterprise/security/hardened-desktop/settings-management/configure-json-file/) and add:
...
You can also configure [Docker socket mount permissions](/admin/enterprise/security/hardened-desktop/enhanced-container-isolation/config/) for trusted images that need Docker API access.
...
- Review [Configure Docker socket exceptions and advanced settings](/admin/enterprise/security/hardened-desktop/enhanced-container-isolation/config/).
- Review [Enhanced Container Isolation limitations](/admin/enterprise/security/hardened-desktop/enhanced-container-isolation/limitations/).
