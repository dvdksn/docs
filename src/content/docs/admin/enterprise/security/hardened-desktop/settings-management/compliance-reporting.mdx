...
sidebar:
  label: Desktop settings reporting
  order: 30
---

import SummaryBar from "@components/SummaryBar.astro";

<SummaryBar featureName="Compliance reporting" />
...
- [Docker Desktop](/manuals/desktop/release-notes/) installed across your organization
- [A verified domain](/manuals/enterprise/security/single-sign-on/connect/)
