...
<SummaryBar featureName="Registry access management" />
...
- [Enforce sign-in](/manuals/enterprise/security/enforce-sign-in/). Registry Access Management only takes effect when users are signed in to Docker Desktop with organization credentials.
...
- [Enforce sign-in](/manuals/enterprise/security/enforce-sign-in/) to prevent bypass through sign-out
...
- Test configuration changes:
    ...
    - Combine with [Enhanced Container Isolation](/manuals/enterprise/security/hardened-desktop/enhanced-container-isolation/) for comprehensive protection
