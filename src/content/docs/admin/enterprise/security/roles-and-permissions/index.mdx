...
<SummaryBar featureName="General admin" />
...
- [Core roles](/manuals/enterprise/security/roles-and-permissions/core-roles/) with predefined permissions
- [Custom roles](/manuals/enterprise/security/roles-and-permissions/custom-roles/) that you can tailor to your specific requirements
