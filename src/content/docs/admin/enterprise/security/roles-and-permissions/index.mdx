...
- [Core roles](/admin/enterprise/security/roles-and-permissions/core-roles/) with predefined permissions
- [Custom roles](/admin/enterprise/security/roles-and-permissions/custom-roles/) that you can tailor to your specific requirements
