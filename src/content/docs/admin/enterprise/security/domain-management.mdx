...
- You may need to [manage seats](/admin/subscription/manage-seats/) to accommodate new users.
...
To prevent unidentifiable users from accessing Docker Desktop, [enforce sign-in](/admin/enterprise/security/enforce-sign-in/).
