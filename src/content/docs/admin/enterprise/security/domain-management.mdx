...
<SummaryBar featureName="Domain management" />
...
- You may need to [manage seats](/manuals/subscription/manage-seats/) to accommodate new users.
...
<SummaryBar featureName="Domain audit" />
...
To prevent unidentifiable users from accessing Docker Desktop, [enforce sign-in](/manuals/enterprise/security/enforce-sign-in/).
