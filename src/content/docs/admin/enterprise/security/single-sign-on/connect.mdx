...
1. For **Configure SAML**, input the following values: 
    ...
    - Optional. Add [SAML attributes](/manuals/enterprise/security/provisioning/#sso-attributes), if required by your org. 
...
1. Optional. Add [SAML attributes](/manuals/enterprise/security/provisioning/#sso-attributes), if required by your org. 
1. From the **SAML Signing Certificate** section, download your **Certificate (Base64)**.

</TabItem>
<TabItem label="Azure OpenID Connect (OIDC)">
...
- [Provision users](/manuals/enterprise/security/provisioning/).
- [Enforce sign-in](../enforce-sign-in/).
- [Create personal access tokens](/manuals/enterprise/security/access-tokens/).
- [Troubleshoot SSO](/manuals/enterprise/troubleshoot/troubleshoot-sso/) issues.
