...
1. For **Configure SAML**, input the following values: 
    ...
    - Optional. Add [SAML attributes](/admin/enterprise/security/provisioning/#sso-attributes), if required by your org. 
...
1. Optional. Add [SAML attributes](/admin/enterprise/security/provisioning/#sso-attributes), if required by your org. 
...
- [Provision users](/admin/enterprise/security/provisioning/).
- [Enforce sign-in](../enforce-sign-in/).
- [Create personal access tokens](/admin/enterprise/security/access-tokens/).
- [Troubleshoot SSO](/admin/enterprise/troubleshoot/troubleshoot-sso/) issues.
