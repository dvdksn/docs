...
[security announcement](/manuals/security/security-announcements/#deprecation-of-password-logins-on-cli-when-sso-enforced).

## Next steps

- Start [configuring SSO](connect/).
- Read the [FAQs](/manuals/enterprise/security/single-sign-on/faqs/general/).
- [Troubleshoot](/manuals/enterprise/troubleshoot/troubleshoot-sso/) SSO issues.
