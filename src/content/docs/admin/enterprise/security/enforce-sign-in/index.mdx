...
Enforcing Docker Desktop sign-in and [enforcing SSO](/admin/enterprise/security/single-sign-on/connect/#optional-enforce-sso) are different features that serve different purposes:
...
- To set up sign-in enforcement, see [Configure sign-in enforcement](/admin/enterprise/security/enforce-sign-in/methods/).
- To configure SSO enforcement, see [Enforce SSO](/admin/enterprise/security/single-sign-on/connect/).
