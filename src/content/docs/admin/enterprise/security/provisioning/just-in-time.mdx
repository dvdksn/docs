...
The following graphic provides an overview of SSO authentication with JIT enabled:
   ...
   ![JIT provisioning enabled workflow](/admin/enterprise/security/images/jit-enabled-flow.svg)
...
![JIT provisioning disabled workflow](/admin/enterprise/security/images/jit-disabled-flow.svg)

## Disable JIT provisioning

> [!WARNING]
>
> Disabling JIT provisioning may disrupt your users' access and workflows. With JIT disabled, users will not be automatically added to your organization. Users must already be a member of the organization or have a pending invitation to successfully sign in through SSO. To auto-provision users with JIT disabled, [use SCIM](./scim/).
...
- Configure [SCIM provisioning](/manuals/enterprise/security/provisioning/scim/) for advanced user management.
- Set up [group mapping](/manuals/enterprise/security/provisioning/group-mapping/) to automatically assign users to teams.
- Review [Troubleshoot provisioning](/manuals/enterprise/troubleshoot/troubleshoot-provisioning/).
