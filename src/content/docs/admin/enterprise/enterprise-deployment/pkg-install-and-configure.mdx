...
<SummaryBar featureName="PKG installer" />
...
- See how you can deploy Docker Desktop for Mac using [Intune](use-intune/) or [Jamf Pro](use-jamf-pro/)
- Explore how to [Enforce sign-in](/manuals/enterprise/security/enforce-sign-in/methods/#plist-method-mac-only) for your users.