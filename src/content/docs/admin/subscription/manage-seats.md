...
1. Select **Billing**.
   ...
   - For more information, see [Verify a bank account](/manuals/billing/payment-method/#verify-a-bank-account).
...
You can now add more members to your organization. For more information, see [Manage organization members](../admin/organization/members/).
