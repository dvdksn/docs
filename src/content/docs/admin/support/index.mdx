...
- Running inside [certain VM or VDI environments](/manuals/desktop/setup/vm-vdi/) (Docker Business only)

</TabItem>
<TabItem label="Not covered">
...
> [!NOTE]
>
> Support for [running Docker Desktop in a VM or VDI environment](/manuals/desktop/setup/vm-vdi/) is only available to Docker Business customers.
...
- [Mac system requirements](/manuals/desktop/setup/install/mac-install/#system-requirements)
- [Windows system requirements](/manuals/desktop/setup/install/windows-install/#system-requirements)
- [Linux system requirements](/manuals/desktop/setup/install/linux/#system-requirements)
