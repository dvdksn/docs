...
- Running inside [certain VM or VDI environments](/desktop/setup/vm-vdi/) (Docker Business only)
...
> [!NOTE]
>
> Support for [running Docker Desktop in a VM or VDI environment](/desktop/setup/vm-vdi/) is only available to Docker Business customers.
...
- [Mac system requirements](/desktop/setup/install/mac-install/#system-requirements)
- [Windows system requirements](/desktop/setup/install/windows-install/#system-requirements)
- [Linux system requirements](/desktop/setup/install/linux/#system-requirements)
