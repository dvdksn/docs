...
- If you have an active Docker subscription, [downgrade it to a Docker Personal subscription](../subscription/change/).
...
- Unlink your [GitHub and account](../docker-hub/repos/manage/builds/link-source/#unlink-a-github-user-account).
