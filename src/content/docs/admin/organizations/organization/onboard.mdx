...
<SummaryBar featureName="Admin orgs" />
...
[Docker subscriptions and features](https://www.docker.com/pricing?ref=Docs&refAction=DocsAdminOnboard).
  ...
  organization, see [Create an organization](/manuals/admin/organization/orgs/).
...
see [Recommended onboarding steps](/manuals/admin/organization/onboard/#recommended-onboarding-steps).
...
details, see [Invite members](/manuals/admin/organization/members/) and
[Roles and permissions](/manuals/enterprise/security/roles-and-permissions/).
...
For more details, see [Invite members](/manuals/admin/organization/members/) and
[Roles and permissions](/manuals/enterprise/security/roles-and-permissions/).
...
subscription, see [Change your subscription](/manuals/subscription/change/).
...
automatically via SSO and SCIM. See the following for more details:
   ...
   - [Configure SSO](/manuals/enterprise/security/single-sign-on/connect/)
   to authenticate and add members when they sign in to Docker through your
   identity provider.
   - Optional.
   [Enforce SSO](/manuals/enterprise/security/single-sign-on/connect/) to
     ...
     > [Enforcing sign-in versus enforcing single sign-on (SSO)](/manuals/enterprise/security/enforce-sign-in/#enforcing-sign-in-versus-enforcing-single-sign-on-sso).

   - [Configure SCIM](/manuals/enterprise/security/provisioning/scim/) to
...
and they can circumvent [Docker’s security features](/manuals/enterprise/security/hardened-desktop/).

There are multiple ways you can enforce sign-in, depending on your organization's
Docker configuration:
- [Registry key method (Windows only)](/manuals/enterprise/security/enforce-sign-in/methods/#registry-key-method-windows-only)
- [`.plist` method (Mac only)](/manuals/enterprise/security/enforce-sign-in/methods/#plist-method-mac-only)
- [`registry.json` method (All)](/manuals/enterprise/security/enforce-sign-in/methods/#registryjson-method-all)
...
- [Image Access Management](/manuals/enterprise/security/hardened-desktop/image-access-management/): Control which types of images your developers can pull from Docker Hub.
- [Registry Access Management](/manuals/enterprise/security/hardened-desktop/registry-access-management/): Define which registries your developers can access.
- [Settings management](/manuals/enterprise/security/hardened-desktop/settings-management/): Set and control Docker Desktop settings for your users.

## What's next

- [Manage Docker products](./manage-products/) to configure access and view usage.
...
- [Manage your domains](/manuals/enterprise/security/domain-management/) to ensure that all Docker users in your domain are part of your organization.
