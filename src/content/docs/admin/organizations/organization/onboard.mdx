...
[Docker subscriptions and features](https://www.docker.com/pricing?ref=Docs&refAction=DocsAdminOnboard).
  ...
  organization, see [Create an organization](/admin/organization/orgs/).
...
see [Recommended onboarding steps](/admin/organization/onboard/#recommended-onboarding-steps).
...
details, see [Invite members](/admin/organization/members/) and
[Roles and permissions](/admin/enterprise/security/roles-and-permissions/).
...
For more details, see [Invite members](/admin/organization/members/) and
[Roles and permissions](/admin/enterprise/security/roles-and-permissions/).
...
subscription, see [Change your subscription](/admin/subscription/change/).
...
automatically via SSO and SCIM. See the following for more details:
   ...
   - [Configure SSO](/admin/enterprise/security/single-sign-on/connect/)
   to authenticate and add members when they sign in to Docker through your
   identity provider.
   - Optional.
   [Enforce SSO](/admin/enterprise/security/single-sign-on/connect/) to
     ...
     > [Enforcing sign-in versus enforcing single sign-on (SSO)](/admin/enterprise/security/enforce-sign-in/#enforcing-sign-in-versus-enforcing-single-sign-on-sso).

   - [Configure SCIM](/admin/enterprise/security/provisioning/scim/) to
...
and they can circumvent [Docker’s security features](/admin/enterprise/security/hardened-desktop/).

There are multiple ways you can enforce sign-in, depending on your organization's
Docker configuration:
- [Registry key method (Windows only)](/admin/enterprise/security/enforce-sign-in/methods/#registry-key-method-windows-only)
- [`.plist` method (Mac only)](/admin/enterprise/security/enforce-sign-in/methods/#plist-method-mac-only)
- [`registry.json` method (All)](/admin/enterprise/security/enforce-sign-in/methods/#registryjson-method-all)
...
- [Image Access Management](/admin/enterprise/security/hardened-desktop/image-access-management/): Control which types of images your developers can pull from Docker Hub.
- [Registry Access Management](/admin/enterprise/security/hardened-desktop/registry-access-management/): Define which registries your developers can access.
- [Settings management](/admin/enterprise/security/hardened-desktop/settings-management/): Set and control Docker Desktop settings for your users.
...
- [Manage your domains](/admin/enterprise/security/domain-management/) to ensure that all Docker users in your domain are part of your organization.
