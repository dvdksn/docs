...
<SummaryBar featureName="Insights" />
...
- Type: User type
- Role: User [role](/manuals/enterprise/security/roles-and-permissions/)
...
[Send usage statistics](/manuals/enterprise/security/hardened-desktop/settings-management/settings-reference/#send-usage-statistics) setting in Docker Desktop
