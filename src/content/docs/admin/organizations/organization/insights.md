...
- Type: User type
- Role: User [role](/admin/enterprise/security/roles-and-permissions/)
...
[Send usage statistics](/admin/enterprise/security/hardened-desktop/settings-management/settings-reference/#send-usage-statistics) setting in Docker Desktop
