...
1. [Enforce sign-in](/manuals/enterprise/security/enforce-sign-in/).
1. Manage members [manually](./members/) or use
[provisioning](/manuals/enterprise/security/provisioning/).
...
[Docker Home](https://app.docker.com/) and configure [Registry Access Management](/manuals/enterprise/security/hardened-desktop/registry-access-management/)
or [Image Access Management](/manuals/enterprise/security/hardened-desktop/image-access-management/).

</TabItem>
<TabItem label="Docker Build Cloud">
...
use [Settings Management](/manuals/enterprise/security/hardened-desktop/settings-management/)
and set `sbomIndexing` to `false` to disable, or to `true` to enable.

</TabItem>
<TabItem label="Testcontainers Cloud">
...
Management](/manuals/enterprise/security/hardened-desktop/settings-management/):
...
reference](/manuals/enterprise/security/hardened-desktop/settings-management/settings-reference/#enable-docker-offload).
...
- Docker Desktop: View the **Insights** page in [Docker Home](https://app.docker.com/). For more details, see [Insights](./insights/).
...
[scale your subscription](../../subscription/scale/) to meet your needs.
