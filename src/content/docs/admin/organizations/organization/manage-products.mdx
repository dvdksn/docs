...
1. [Enforce sign-in](/admin/enterprise/security/enforce-sign-in/).
1. Manage members [manually](./members/) or use
[provisioning](/admin/enterprise/security/provisioning/).
...
[Docker Home](https://app.docker.com/) and configure [Registry Access Management](/admin/enterprise/security/hardened-desktop/registry-access-management/)
or [Image Access Management](/admin/enterprise/security/hardened-desktop/image-access-management/).
...
use [Settings Management](/admin/enterprise/security/hardened-desktop/settings-management/)
...
Management](/admin/enterprise/security/hardened-desktop/settings-management/):
...
reference](/admin/enterprise/security/hardened-desktop/settings-management/settings-reference/#enable-docker-offload).
