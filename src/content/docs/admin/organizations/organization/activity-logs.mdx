...
<SummaryBar featureName="Activity logs" />
...
To view activity logs using the Docker Hub API, use the [Audit logs endpoints](https://docs.docker.com/hub/api/latest/#tag/audit-logs).
...
[Docker Hub API](https://docs.docker.com/hub/api/latest/#tag/audit-logs).
