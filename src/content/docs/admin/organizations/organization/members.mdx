...
You can bulk invite members using the Docker Hub API. For more information, see the [Bulk create invites](https://docs.docker.com/hub/api/latest/#tag/invites/paths/~1v2~1invites~1bulk/post) API endpoint.
