...
sidebar:
  label: Unassociated machines
  order: 40
---

import { Aside } from "@astrojs/starlight/components";

<Aside type="tip" title="About unassociated machines">
...
- Automatic addition:
    ...
    auto-provisioning, see [Domain management](/admin/enterprise/security/domain-management/).
    - SSO user provisioning: If you have SSO configured with
    [Just-in-Time provisioning](/admin/enterprise/security/provisioning/just-in-time/),
