...
Hardened Images and charts](./customize/).

## Verify a Helm chart and view its attestations

You can verify Helm charts. For more details, see [Verify Helm chart attestations](./verify/#verify-helm-chart-attestations-with-docker-scout).