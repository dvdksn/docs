...
[VEX](/manuals/dhi/core-concepts/vex/) attestations. The following scanners can
...
integrations](/manuals/dhi/explore/scanner-integrations/).
...
Scout with other systems](/manuals/scout/integrations/).
...
> details, see [Mirror to a third-party registry](mirror/#mirror-to-a-third-party-registry).
