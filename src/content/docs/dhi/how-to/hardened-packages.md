...
customization](./customize/#create-an-image-customization) and select hardened
...
5. Build the image passing credentials as a secret using the DHI CLI
  ...
  > more information, see [Use the DHI CLI](./cli/).
...
attestations](./verify/). These attestations provide provenance and build
