...
sidebar:
  label: Manage images and charts
  order: 35
---
...
Alternatively, you can use the [DHI CLI](./cli/) to manage mirrored
...
repositories](/manuals/docker-hub/repos/) for details. The **Manage**
