...
sidebar:
  label: Use DHI Select & Enterprise
---
...
- [Docker Desktop](../../desktop/release-notes/) 4.65 or later to use the
  `docker dhi` CLI.
...
images see [Search and evaluate Docker Hardened Images](explore/).
...
images see [Mirror a repository](mirror/).
...
- [Use a Docker Hardened Image](use/) for general usage
- [Use a Helm chart](helm/) for deploying with Helm
...
- [Verify DHIs](verify/): Use tools like [Docker Scout](/scout/) or Cosign to
  inspect and verify signed attestations, like SBOMs and provenance.

- [Scan DHIs](scan/): Analyze the image with Docker Scout or other scanners
