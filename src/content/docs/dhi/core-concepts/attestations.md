...
For more details, see [Verify image attestations](../how-to/verify/#verify-image-attestations).
...
| Virus scan                 | Results of antivirus scans performed on the image layers. For details, see [Malware scanning](../explore/malware-scanning/).                                                            |
...
[Package attestations](../how-to/hardened-packages/#package-attestations).
...
For more details, see [Verify Helm chart attestations](../how-to/verify/#verify-helm-chart-attestations-with-docker-scout).
...
| Virus scan                 | Results of antivirus scans performed on the chart package. For details, see [Malware scanning](../explore/malware-scanning/).                                                                                                |
