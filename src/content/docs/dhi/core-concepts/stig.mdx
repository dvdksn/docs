...
images](../how-to/explore/#image-variants) and:
...
To use a STIG variant, you must [mirror](../how-to/mirror/) the repository
...
attestation](../core-concepts/attestations/) for each STIG-ready image.
