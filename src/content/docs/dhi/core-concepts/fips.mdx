...
To find DHI repositories with FIPS image variants, [search the catalog](../how-to/explore/) and:
...
To use a FIPS variant, you must [mirror](../how-to/mirror/) the repository
