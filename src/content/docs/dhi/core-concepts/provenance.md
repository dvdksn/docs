...
DHIs include [attestations](./attestations/)—machine-readable metadata that
...
Each Docker Hardened Image is cryptographically [signed](./signatures/) and
...
- [Attestations overview](./attestations/)