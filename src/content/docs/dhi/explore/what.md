...
- SLSA-compliant builds: Docker Hardened Images are built to meet [SLSA Build
  Level 3](../core-concepts/slsa/), ensuring a tamper-resistant, verifiable,
...
-  Distroless approach: Unlike traditional base images that bundle an entire OS
   ...
   images](../core-concepts/distroless/) retain only the minimal OS components
...
- Continuous maintenance: All DHIs are continuously monitored and updated to
  maintain near-zero known exploitable [CVEs](../core-concepts/cves/), helping
  your teams avoid patch fatigue and surprise alerts.

- Compliance-ready: Each image includes cryptographically signed metadata:
  - [SBOMs](../core-concepts/sbom/) that show what's in the image
  - [VEX documents](../core-concepts/vex/) to identify which vulnerabilities
    are actually exploitable
  - [Build provenance](../core-concepts/provenance/) that proves how and where
    the image was built
