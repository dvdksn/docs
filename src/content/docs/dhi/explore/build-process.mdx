...
verify them, see [SLSA](../core-concepts/slsa/).
...
5. Testing and scanning: Images undergo comprehensive
   [testing](test/) for compatibility and functionality, and are
   [scanned for malware](malware-scanning/), secrets, and
   vulnerabilities.
...
5. Scanning: The customized image is [scanned for
   malware](malware-scanning/), secrets, and vulnerabilities.
