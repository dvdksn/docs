...
advisories](/scout/deep-dive/advisory-db-sources/), and updates its
...
The SBOM is cross-referenced with the [advisory database](/scout/deep-dive/advisory-db-sources/)
...
<YouTube id="qOzcycbTs4o" />

[Build attestations](/build/metadata/attestations/) give you
