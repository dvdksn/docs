...
<TabItem label="Using the official image">
...
Complete [Containerize a Deno application](#containerize-your-app).
...
Complete all the previous sections of this guide, starting with [Containerize a Deno application](#containerize-your-app). You must have a [GitHub](https://github.com/signup) account and a verified [Docker](https://hub.docker.com/signup) account to complete this section.
...
Related information:
 - [Introduction to GitHub Actions](/build/ci/github-actions/)
...
- Complete all the previous sections of this guide, starting with [Containerize a Deno application](#containerize-your-app).
