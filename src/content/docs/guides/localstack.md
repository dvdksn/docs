...
sidebar:
  label: AWS development with LocalStack
---
...
2. Bring up LocalStack
   ...
   ![Diagram showing the LocalStack and Mongo container up and running on Docker Desktop ](/guides/images/launch-localstack.webp)

3. Verify that LocalStack is up and running by selecting the container and checking the logs.

   ![Diagram showing the logs of LocalStack container ](/guides/images/localstack-logs.webp)
...
4. Creating a Local Amazon S3 Bucket
   ...
   To create Local Amazon S3 bucket, install the [`awscli-local` CLI](https://github.com/localstack/awscli-local) on your system. The `awslocal` command is a thin wrapper around the AWS command line interface for use with LocalStack. It lets you to test and develop against a simulated environment on your local machine without needing to access the real AWS services.
    ...
    ![Diagram showing the logs of LocalStack that highlights the S3 bucket being created successfully ](/guides/images/localstack-s3put.webp)
...
![Diagram showing the tech stack of the sample todo-list application that includes LocalStack, frontend and backend services ](/guides/images/localstack-arch.webp)
...
3. Start the frontend service
   ...
   ![Diagram showing a working todo-list application](/guides/images/localstack-todolist.webp)

   You can verify the image is uploaded to the S3 bucket by checking the LocalStack container logs:

   ![Diagram showing the logs of the LocalStack that highlights image uploaded to the emulated S3 bucket](/guides/images/localstack-todolist-s3put.webp)
