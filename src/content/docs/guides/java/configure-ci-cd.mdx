...
Complete the previous sections of this guide, starting with [Containerize your app](containerize/). You must have a [GitHub](https://github.com/signup) account and a verified [Docker](https://hub.docker.com/signup) account to complete this section.
