...
Work through the steps to containerize your application in [Containerize your app](containerize/).
...
![Java Connect a Debugger](/guides/java/images/connect-debugger.webp)
...
![Debug menu](/guides/java/images/debug-menu.webp)

You should now see the connection in the logs of your Compose application.

![Compose log file ](/guides/java/images/compose-logs.webp)
...
![Debugger code breakpoint](/guides/java/images/debugger-breakpoint.webp)
...
[Use Compose Watch](/manuals/compose/how-tos/file-watch/).
...
- [Compose Watch](/manuals/compose/how-tos/file-watch/)
