...
To follow along with this guide, you must have Docker installed. To install Docker, see [Get Docker](/get-started/install/).
...
5. In the optional settings, specify the following:
   ...
   ![The optional settings screen with the options specified.](/guides/images/databases-1.webp)
...
5. In the optional settings, specify the following:
   ...
   ![The optional settings screen with the options specified.](/guides/images/databases-2.webp)
...
1. Run a container with a volume attached.
   ...
   5. In the optional settings, specify the following:
      ...
      ![The optional settings screen with the options specified.](/guides/images/databases-3.webp)
