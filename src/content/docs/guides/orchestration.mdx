...
1. [Set up and use a Kubernetes environment on your development machine](kube-deploy/)
2. [Set up and use a Swarm environment on your development machine](swarm-deploy/)
...
- [Deploy to Kubernetes](kube-deploy/)
- [Deploy to Swarm](swarm-deploy/)
