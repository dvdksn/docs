...
- Docker running locally. Follow the [instructions to download and install Docker](/manuals/desktop/).
...
> [!NOTE]
>
> If you are curious about creating your own base images, you can check out the following section of this guide: [creating base images](/manuals/build/building/base-images/#create-a-base-image).
...
> reference](/reference/dockerfile/#copy). This trailing slash can
...
Desktop](/manuals/desktop/). Since you're currently working in the
...
These two issues can be solved by using [multi-stage builds](/manuals/build/building/multi-stage/).
...
so feel free to check out [multi-stage builds](/manuals/build/building/multi-stage/). This is, however, not essential for your progress here.
