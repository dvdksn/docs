...
sidebar:
  label: Video transcription and chat
---
...
2. Once the application appears, in the **Youtube URL** field specify a Youtube video URL
   ...
   ![Submitting a video in the yt-whisper service](/guides/genai-video-bot/images/yt-whisper.webp)
   ...
   ![A processed video in the yt-whisper service](/guides/genai-video-bot/images/yt-whisper-2.webp)
...
2. In the **What do you want to know about your videos?** text box, ask the
   ...
   ![Asking a question to the Dockerbot](/guides/genai-video-bot/images/bot.webp)
...
![Application architecture diagram](/guides/genai-video-bot/images/architecture.webp)
...
underlying system differences. To learn more about Docker, see the [Getting started overview](/get-started/introduction/).

Docker Compose is a tool for defining and running multi-container applications.
Compose makes it easy to run this application with a single command, `docker
compose up`. For more details, see the [Compose overview](/manuals/compose/).
...
![Embedding diagram](/guides/genai-video-bot/images/embeddings.webp)
...
Explore how to [create a PDF bot application](/guides/genai-pdf-bot/) using
