...
- [docker-entrypoint](/build/dockerfile/#entrypoint)
...
Complete all the previous sections of this guide, starting with [Containerize a Ruby on Rails application](#containerize-your-app). You must have a [GitHub](https://github.com/signup) account and a verified [Docker](https://hub.docker.com/signup) account to complete this section.
...
Complete [Containerize a Ruby on Rails application](#containerize-your-app).
...
- Complete all the previous sections of this guide, starting with [Containerize a Ruby on Rails application](#containerize-your-app).
...
your Ruby on Rails application](#automate-your-builds-with-github-actions).
