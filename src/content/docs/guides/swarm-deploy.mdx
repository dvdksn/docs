...
- Work through containerizing an application in [Docker workshop part 2](/get-started/build-your-first-app/)
...
- [Swarm Mode Services](/engine/swarm/how-swarm-mode-works/services/)
- [Swarm Stacks](/engine/swarm/stack-deploy/)
