...
import Include_swarm_compose_compat from "@includes/swarm-compose-compat.mdx";
import Include_swarm_mode from "@includes/swarm-mode.mdx";
...
- Work through containerizing an application in [Docker workshop part 2](/get-started/workshop/02_our_app/)
...
Now you can write a simple stack file to run and manage your Todo app, the container `getting-started` image created in [Part 2](02_our_app/) of the tutorial. Place the following in a file called `bb-stack.yaml`:

<Include_swarm_compose_compat />
...
3. Open a browser and visit your Todo app at `localhost:8000`; you should see your Todo application, the same as when you ran it as a stand-alone container in [Part 2](02_our_app/) of the tutorial.
...
- [Swarm Mode](/manuals/engine/swarm/)
- [Swarm Mode Services](/manuals/engine/swarm/how-swarm-mode-works/services/)
- [Swarm Stacks](/manuals/engine/swarm/stack-deploy/)
