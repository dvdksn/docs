...
- You have installed the latest version of [Docker Desktop](/get-started/install/) or, if you are a Linux user and are planning to use GPU acceleration, [Docker Engine](/engine/install/). Docker adds new features regularly and some parts of this guide may work only with the latest version of Docker Desktop.
