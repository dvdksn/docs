...
You have completed [Build your Rust image](build-images/) and you have built an image.
...
Use `docker run` to run the image you built in [Build your Rust image](build-images/).
