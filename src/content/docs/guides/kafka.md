...
sidebar:
  label: Event-driven apps with Kafka
---
...
![Diagram showing the DOCKER and HOST listeners and how they are exposed to the host and Docker networks](/guides/images/kafka-1.webp)
