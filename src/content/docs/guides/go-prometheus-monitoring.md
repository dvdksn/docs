...
sidebar:
  label: Monitor with Prometheus and Grafana
---
...
Related information:
 ...
 - [.dockerignore file](/build/dockerfile/#dockerignore-file)
...
![The optional settings screen with the options specified.](/guides/images/grafana-dash.png)
...
![The optional settings screen with the options specified.](/guides/images/grafana-panel.png)
